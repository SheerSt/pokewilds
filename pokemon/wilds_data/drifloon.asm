    ...
    db 425 ; Dex number.
    db <Perhaps seeking company, it approaches children. However, it often quickly runs away again when the children play too roughly with it.> ; Dex entry.

    db 1.2 ; Weight in kg.
    db 0.4 ; Height in meters.

    db DRIFLOON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
