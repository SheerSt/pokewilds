    ...
    db 470 ; Dex number.
    db <Galarians favor the distinctive aroma that drifts from this Pok�mon's leaves. There's a popular perfume made using that scent.> ; Dex entry.

    db 25.5 ; Weight in kg.
