    ...
    db 450 ; Dex number.
    db <Stones can get stuck in the ports on their bodies. Dwebble help dislodge such stones, so Hippowdon look after these Pok�mon.> ; Dex entry.

    db 300.0 ; Weight in kg.
