    ...
    db 261 ; Dex number.
    db <At first sight, Poochyena takes a bite at anything that moves. This Pok�mon chases after prey until the victim becomes exhausted. However, it may turn tail if the prey strikes back.> ; Dex entry.
