    ...
    db 50 ; Dex number.
    db <If a Diglett digs through a field, it leaves the soil perfectly tilled and ideal for planting crops.> ; Dex entry.

    db 0.8 ; Weight in kg.
    db 0.2 ; Height in meters.

    db DIGLETT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db SAND_PIT VOLCANO ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
