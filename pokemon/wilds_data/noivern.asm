    ...
    db 715 ; Dex number.
    db <Aggressive and cruel, this Pok�mon will ruthlessly torment enemies that are helpless in the dark.> ; Dex entry.

    db 85.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db NOIBAT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
