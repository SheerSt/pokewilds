    ...
    db 643 ; Dex number.
    db <Flames spew from its tail as it flies through the sky like a jet airplane. It's said that this Pok�mon will scorch the world.> ; Dex entry.

    db 330.0 ; Weight in kg.
    db 3.2 ; Height in meters.

    db RESHIRAM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
