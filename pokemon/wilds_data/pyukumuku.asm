    ...
    db 771 ; Dex number.
    db <It lives in warm, shallow waters. If it encounters a foe, it will spit out its internal organs as a means to punch them.> ; Dex entry.

    db 1.2 ; Weight in kg.
    db 0.3 ; Height in meters.

    db PYUKUMUKU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
