    ...
    db 742 ; Dex number.
    db <Nectar and pollen are its favorite fare. You can find Cutiefly hovering around Gossifleur, trying to get some of Gossifleur's pollen.> ; Dex entry.

    db 0.2 ; Weight in kg.
    db 0.1 ; Height in meters.

    db CUTIEFLY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
