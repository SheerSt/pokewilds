    ...
    db 259 ; Dex number.
    db <The surface of Marshtomp's body is enveloped by a thin, sticky film that enables it to live on land. This Pok�mon plays in mud on beaches when the ocean tide is low.> ; Dex entry.
