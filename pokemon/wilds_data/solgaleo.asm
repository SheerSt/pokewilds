    ...
    db 791 ; Dex number.
    db <When light radiates from its body, this Pok�mon could almost appear to be the sun. It will dispel any darkness and light up the world.> ; Dex entry.

    db 230.0 ; Weight in kg.
    db 3.4 ; Height in meters.

    db COSMOG 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
