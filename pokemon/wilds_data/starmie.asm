    ...
    db 121 ; Dex number.
    db <This Pok�mon has an organ known as its core. The organ glows in seven colors when Starmie is unleashing its potent psychic powers.> ; Dex entry.

    db 80.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db STARYU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
