    ...
    db 92 ; Dex number.
    db <Born from gases, anyone would faint if engulfed by its gaseous body, which contains poison.> ; Dex entry.

    db 0.1 ; Weight in kg.
    db 1.3 ; Height in meters.

    db GASTLY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
