    ...
    db 133 ; Dex number.
    db <Gigantamax energy upped the fluffiness of the fur around Eevee's neck. The fur will envelop a foe, capturing its body and captivating its mind.> ; Dex entry.

    db 6.5 ; Weight in kg.
    db 0.3 ; Height in meters.

    db EEVEE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
