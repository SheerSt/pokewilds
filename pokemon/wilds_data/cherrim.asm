    ...
    db 421 ; Dex number.
    db <After absorbing plenty of sunlight, Cherrim takes this form. It's full of energy while it's like this, and its liveliness will go on until sundown.> ; Dex entry.

    db 9.3 ; Weight in kg.
    db 0.5 ; Height in meters.

    db CHERUBI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
