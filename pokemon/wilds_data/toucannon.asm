    ...
    db 733 ; Dex number.
    db <When it battles, its beak heats up. The temperature can easily exceed 212 degrees Fahrenheit, causing severe burns when it hits.> ; Dex entry.

    db 26.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db PIKIPEK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
