    ...
    db 553 ; Dex number.
    db <This Pok�mon is known as the Bully of the Sands. Krookodile's mighty jaws can bite through heavy plates of iron with almost no effort at all.> ; Dex entry.

    db 96.3 ; Weight in kg.
    db 1.5 ; Height in meters.

    db SANDILE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
