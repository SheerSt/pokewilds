    ...
    db 322 ; Dex number.
    db <Numel is extremely dull witted�it doesn't notice being hit. However, it can't stand hunger for even a second. This Pok�mon's body is a seething cauldron of boiling magma.> ; Dex entry.

    db 24.0 ; Weight in kg.
    db 0.7 ; Height in meters.

    db NUMEL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db DESERT VOLCANO ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
