    ...
    db 241 ; Dex number.
    db <Miltank produces highly nutritious milk, so it's been supporting the lives of people and other Pok�mon since ancient times.> ; Dex entry.

    db 75.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db MILTANK 50, TAUROS 50 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
