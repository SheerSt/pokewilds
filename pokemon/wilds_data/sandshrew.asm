    ...
    db 27 ; Dex number.
    db <It loves to bathe in the grit of dry, sandy areas. By sand bathing, the Pok�mon rids itself of dirt and moisture clinging to its body.> ; Dex entry.

    db 12.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db SANDSHREW 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db OASIS RUINS_INNER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
