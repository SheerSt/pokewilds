    ...
    db 797 ; Dex number.
    db <It appeared from the Ultra Wormhole. Witnesses observed it flying across the sky at high speed.> ; Dex entry.

    db 999.9 ; Weight in kg.
    db 9.2 ; Height in meters.

    db CELESTEELA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
