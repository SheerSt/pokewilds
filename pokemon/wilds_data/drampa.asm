    ...
    db 780 ; Dex number.
    db <The mountains it calls home are nearly two miles in height. On rare occasions, it descends to play with the children living in the towns below.> ; Dex entry.

    db 185.0 ; Weight in kg.
    db 3.0 ; Height in meters.

    db DRAMPA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
