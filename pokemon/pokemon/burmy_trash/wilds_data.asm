    db BURMY ; Display name (DEFAULT for default name).

    db 412 ; Dex number.
    db <To shelter itself from cold, wintry winds, it covers itself with a cloak made of twigs and leaves.> ; Dex entry.

    db 3.4 ; Weight in kg.
    db 0.2 ; Height in meters.

    db BURMY_TRASH 100 ; Base form(s) (MON_NAME for base species, then chance).
