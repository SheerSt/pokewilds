    ...
    db 874 ; Dex number.
    db <It stands in grasslands, watching the sun's descent from zenith to horizon. This Pokémon has a talent for delivering dynamic kicks.> ; Dex entry.

    db 520.0 ; Weight in kg.
    db 2.5 ; Height in meters.

    db STONJOURNER 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
