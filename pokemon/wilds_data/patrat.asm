    ...
    db 504 ; Dex number.
    db <Using food stored in cheek pouches, they can keep watch for days. They use their tails to communicate with others.> ; Dex entry.

    db 11.6 ; Weight in kg.
    db 0.5 ; Height in meters.

    db PATRAT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
