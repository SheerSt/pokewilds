    ...
    db 521 ; Dex number.
    db <Females of this species are very capable fliers, particularly notable for their stamina. They also take longer to adjust to people.> ; Dex entry.

    db 29.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db PIDOVE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
