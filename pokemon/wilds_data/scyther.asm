    ...
    db 123 ; Dex number.
    db <As Scyther fights more and more battles, its scythes become sharper and sharper. With a single slice, Scyther can fell a massive tree.> ; Dex entry.

    db 56.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db SCYTHER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db DEEP_FOREST SAVANNA WOODED_LAKE ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
