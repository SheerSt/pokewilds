    ...
    db 658 ; Dex number.
    db <It creates throwing stars out of compressed water. When it spins them and throws them at high speed, these stars can split metal in two.> ; Dex entry.

    db 40.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db FROAKIE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
