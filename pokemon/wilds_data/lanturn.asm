    ...
    db 171 ; Dex number.
    db <The light it emits is so bright that it can illuminate the sea's surface from a depth of over three miles.> ; Dex entry.

    db 22.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db CHINCHOU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
