    ...
    db 644 ; Dex number.
    db <When the interior part of its tail spins like a motor, Zekrom can generate many bolts of lightning to blast its surroundings.> ; Dex entry.

    db 345.0 ; Weight in kg.
    db 2.9 ; Height in meters.

    db ZEKROM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
