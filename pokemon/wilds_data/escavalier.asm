    ...
    db 589 ; Dex number.
    db <They use shells they've stolen from Shelmet to arm and protect themselves. They're very popular Pokémon in the Galar region.> ; Dex entry.

    db 33.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db KARRABLAST, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
