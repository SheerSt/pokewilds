    ...
    db 638 ; Dex number.
    db <It has a body and heart of steel. Its glare is sufficient to make even an unruly Pok�mon obey it.> ; Dex entry.

    db 250.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db COBALION 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
