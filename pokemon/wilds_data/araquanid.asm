    ...
    db 752 ; Dex number.
    db <It launches water bubbles with its legs, drowning prey within the bubbles. This Pok�mon can then take its time to savor its meal.> ; Dex entry.

    db 82.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db DEWPIDER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
