    ...
    db 39 ; Dex number.
    db <Jigglypuff has top-notch lung capacity, even by comparison to other Pok�mon. It won't stop singing its lullabies until its foes fall asleep.> ; Dex entry.
