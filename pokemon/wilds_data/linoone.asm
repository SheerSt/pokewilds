    ...
    db 264 ; Dex number.
    db <It uses its long tongue to taunt opponents. Once the opposition is enraged, this Pok�mon hurls itself at the opponent, tackling them forcefully.> ; Dex entry.
