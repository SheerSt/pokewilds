    ...
    db 299 ; Dex number.
    db <The magnet in Nosepass's nose provides an unerring compass, making it an excellent partner for Trainers going on a journey.> ; Dex entry.

    db 97.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db NOSEPASS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
