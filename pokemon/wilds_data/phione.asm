    ...
    db 489 ; Dex number.
    db <When the water warms, they inflate the flotation sac on their heads and drift languidly on the sea in packs.> ; Dex entry.

    db 3.1 ; Weight in kg.
    db 0.4 ; Height in meters.

    db PHIONE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
