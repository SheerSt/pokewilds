    ...
    db 829 ; Dex number.
    db <It anchors itself in the ground with its single leg, then basks in the sun. After absorbing enough sunlight, its petals spread as it blooms brilliantly.> ; Dex entry.

    db 2.2 ; Weight in kg.
    db 0.4 ; Height in meters.

    db GOSSIFLEUR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
