    ...
    db 770 ; Dex number.
    db <Palossand is known as the Beach Nightmare. It pulls its prey down into the sand by controlling the sand itself, and then it sucks out their souls.> ; Dex entry.

    db 250.0 ; Weight in kg.
    db 1.3 ; Height in meters.

    db SANDYGAST 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
