    ...
    db 380 ; Dex number.
    db <Latias is highly sensitive to the emotions of people. If it senses any hostility, this Pok�mon ruffles the feathers all over its body and cries shrilly to intimidate the foe.> ; Dex entry.

    db 40.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db LATIAS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
