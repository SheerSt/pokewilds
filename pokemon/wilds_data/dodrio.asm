    ...
    db 85 ; Dex number.
    db <Watch out if Dodrio's three heads are looking in three separate directions. It's a sure sign that it is on its guard. Don't go near this Pok�mon if it's being wary�it may decide to peck you.> ; Dex entry.

    db 85.2 ; Weight in kg.
