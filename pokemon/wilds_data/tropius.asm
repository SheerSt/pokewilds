    ...
    db 357 ; Dex number.
    db <The bunches of fruit around Tropius's neck are very popular with children. This Pokémon loves fruit, and eats it continuously. Apparently, its love for fruit resulted in its own outgrowth of fruit.> ; Dex entry.

    db 100.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db TROPIUS 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
