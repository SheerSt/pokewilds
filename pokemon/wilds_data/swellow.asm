    ...
    db 277 ; Dex number.
    db <Swellow flies high above our heads, making graceful arcs in the sky. This Pok�mon dives at a steep angle as soon as it spots its prey. The hapless prey is tightly grasped by Swellow's clawed feet, preventing escape.> ; Dex entry.

    db 19.8 ; Weight in kg.
