    ...
    db 609 ; Dex number.
    db <This Pok�mon haunts dilapidated mansions. It sways its arms to hypnotize opponents with the ominous dancing of its flames.> ; Dex entry.

    db 34.3 ; Weight in kg.
    db 1.0 ; Height in meters.

    db LITWICK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
