    ...
    db 493 ; Dex number.
    db <According to the legends of Sinnoh, this Pok�mon emerged from an egg and shaped all there is in this world.> ; Dex entry.

    db 320.0 ; Weight in kg.
    db 3.2 ; Height in meters.

    db ARCEUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
