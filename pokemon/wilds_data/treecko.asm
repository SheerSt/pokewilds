    ...
    db 252 ; Dex number.
    db <Treecko has small hooks on the bottom of its feet that enable it to scale vertical walls. This Pok�mon attacks by slamming foes with its thick tail.> ; Dex entry.
