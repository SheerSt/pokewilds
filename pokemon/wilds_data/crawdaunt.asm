    ...
    db 342 ; Dex number.
    db <A rough customer that wildly flails its giant claws. It is said to be extremely hard to raise.> ; Dex entry.

    db 32.8 ; Weight in kg.
    db 1.1 ; Height in meters.

    db CORPHISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
