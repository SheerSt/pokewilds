    ...
    db 461 ; Dex number.
    db <They attack their quarry in packs. Prey as large as Mamoswine easily fall to the teamwork of a group of Weavile.> ; Dex entry.

    db 34.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db SNEASEL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
