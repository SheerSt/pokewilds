    ...
    db 799 ; Dex number.
    db <It has gobbled mountains and swallowed whole buildings, according to reports. It's one of the Ultra Beasts.> ; Dex entry.

    db 888.0 ; Weight in kg.
    db 5.5 ; Height in meters.

    db GUZZLORD 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
