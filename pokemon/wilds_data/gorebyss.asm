    ...
    db 368 ; Dex number.
    db <Gorebyss lives in the southern seas at extreme depths. Its body is built to withstand the enormous pressure of water at incredible depths. Because of this, this Pokémon's body is unharmed by ordinary attacks.> ; Dex entry.

    db 22.6 ; Weight in kg.
    db 1.8 ; Height in meters.

    db CLAMPERL, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
