    ...
    db 301 ; Dex number.
    db <Delcatty prefers to live an unfettered existence in which it can do as it pleases at its own pace. Because this Pok�mon eats and sleeps whenever it decides, its daily routines are completely random.> ; Dex entry.

    db 32.6 ; Weight in kg.
    db 1.1 ; Height in meters.

    db SKITTY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
