    ...
    db 898 ; Dex number.
    db <Calyrex is a merciful Pok�mon, capable of providing healing and blessings. It reigned over the Galar region in times of yore.> ; Dex entry.

    db 7.7 ; Weight in kg.
    db 1.1 ; Height in meters.

    db CALYREX 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
