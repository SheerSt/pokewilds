    ...
    db 497 ; Dex number.
    db <It only gives its all against strong opponents who are not fazed by the glare from Serperior's noble eyes.> ; Dex entry.

    db 63.0 ; Weight in kg.
    db 3.3 ; Height in meters.

    db SNIVY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
