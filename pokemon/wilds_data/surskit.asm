    ...
    db 283 ; Dex number.
    db <It moves as if skating on the surface of the water. It often fights with Dewpider over food.> ; Dex entry.

    db 1.7 ; Weight in kg.
    db 0.5 ; Height in meters.

    db SURSKIT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
