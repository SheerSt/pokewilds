    ...
    db 95 ; Dex number.
    db <As it digs through the ground, it absorbs many hard objects. This is what makes its body so solid.> ; Dex entry.

    db 210.0 ; Weight in kg.
    db 8.8 ; Height in meters.

    db ONIX 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
