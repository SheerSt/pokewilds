    ...
    db 395 ; Dex number.
    db <It swims as fast as a jet boat. The edges of its wings are sharp and can slice apart drifting ice.> ; Dex entry.

    db 84.5 ; Weight in kg.
    db 1.7 ; Height in meters.

    db PIPLUP 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
