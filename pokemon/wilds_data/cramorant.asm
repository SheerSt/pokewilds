    ...
    db 845 ; Dex number.
    db <Cramorant's gluttony led it to try to swallow an Arrokuda whole, which in turn led to Cramorant getting an Arrokuda stuck in its throat.> ; Dex entry.

    db 18.0 ; Weight in kg.
    db 0.8 ; Height in meters.

    db CRAMORANT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
