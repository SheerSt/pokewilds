    ...
    db 157 ; Dex number.
    db <Typhlosion obscures itself behind a shimmering heat haze that it creates using its intensely hot flames. This Pok�mon creates blazing explosive blasts that burn everything to cinders.> ; Dex entry.
