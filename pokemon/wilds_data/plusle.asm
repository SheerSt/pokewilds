    ...
    db 311 ; Dex number.
    db <Plusle always acts as a cheerleader for its partners. Whenever a teammate puts out a good effort in battle, this Pok�mon shorts out its body to create the crackling noises of sparks to show its joy.> ; Dex entry.

    db 4.2 ; Weight in kg.
    db 0.4 ; Height in meters.

    db PLUSLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
