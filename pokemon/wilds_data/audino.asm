    ...
    db 531 ; Dex number.
    db <Using the feelers on its ears, it can tell how someone is feeling or when an egg might hatch.> ; Dex entry.

    db 31.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db AUDINO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
