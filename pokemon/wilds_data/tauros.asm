    ...
    db 128 ; Dex number.
    db <When Tauros begins whipping itself with its tails, it's a warning that the Pok�mon is about to charge with astounding speed.> ; Dex entry.

    db 88.4 ; Weight in kg.
    db 1.4 ; Height in meters.

    db TAUROS 50, MILTANK 50 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
