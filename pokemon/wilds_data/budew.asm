    ...
    db 406 ; Dex number.
    db <The pollen it releases contains poison. If this Pok�mon is raised on clean water, the poison's toxicity is increased.> ; Dex entry.

    db 1.2 ; Weight in kg.
    db 0.2 ; Height in meters.

    db BUDEW 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
