    ...
    db 114 ; Dex number.
    db <Hidden beneath a tangle of vines that grows nonstop even if the vines are torn off, this Pok�mon's true appearance remains a mystery.> ; Dex entry.

    db 35.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db TANGELA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
