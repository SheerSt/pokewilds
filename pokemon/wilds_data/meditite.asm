    ...
    db 307 ; Dex number.
    db <Meditite undertakes rigorous mental training deep in the mountains. However, whenever it meditates, this Pok�mon always loses its concentration and focus. As a result, its training never ends.> ; Dex entry.

    db 11.2 ; Weight in kg.
    db 0.6 ; Height in meters.

    db MEDITITE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
