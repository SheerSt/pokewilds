    ...
    db 452 ; Dex number.
    db <Its poison is potent, but it rarely sees use. This Pok�mon prefers to use physical force instead, going on rampages with its car-crushing strength.> ; Dex entry.

    db 61.5 ; Weight in kg.
    db 1.3 ; Height in meters.

    db SKORUPI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
