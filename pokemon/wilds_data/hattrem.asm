    ...
    db 857 ; Dex number.
    db <No matter who you are, if you bring strong emotions near this Pok�mon, it will silence you violently.> ; Dex entry.

    db 4.8 ; Weight in kg.
    db 0.6 ; Height in meters.

    db HATENNA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
