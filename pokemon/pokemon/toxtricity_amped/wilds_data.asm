    db TOXTRICITY ; Display name (DEFAULT for default name).

    db 849 ; Dex number.
    db <When this Pokémon sounds as if it's strumming a guitar, it’s actually clawing at the protrusions on its chest to generate electricity.> ; Dex entry.

    db 40.0 ; Weight in kg.
    db 1.6 ; Height in meters.

    db TOXEL 100 ; Base form(s) (MON_NAME for base species, then chance).
