    ...
    db 760 ; Dex number.
    db <Once it accepts you as a friend, it tries to show its affection with a hug. Letting it do that is dangerous�it could easily shatter your bones.> ; Dex entry.

    db 135.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db STUFFUL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
