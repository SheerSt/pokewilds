    ...
    db 468 ; Dex number.
    db <These Pok�mon are never seen anywhere near conflict or turmoil. In recent times, they've hardly been seen at all.> ; Dex entry.

    db 38.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db TOGEPI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
