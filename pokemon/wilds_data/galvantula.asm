    ...
    db 596 ; Dex number.
    db <It launches electrified fur from its abdomen as its means of attack. Opponents hit by the fur could be in for three full days and nights of paralysis.> ; Dex entry.

    db 14.3 ; Weight in kg.
    db 0.8 ; Height in meters.

    db JOLTIK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
