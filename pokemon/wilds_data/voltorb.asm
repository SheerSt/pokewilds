    ...
    db 100 ; Dex number.
    db <Voltorb was first sighted at a company that manufactures Pok� Balls. The link between that sighting and the fact that this Pok�mon looks very similar to a Pok� Ball remains a mystery.> ; Dex entry.

    db 10.4 ; Weight in kg.
    db 0.5 ; Height in meters.

    db VOLTORB 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
