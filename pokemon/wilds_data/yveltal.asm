    ...
    db 717 ; Dex number.
    db <When this legendary Pokémon's wings and tail feathers spread wide and glow red, it absorbs the life force of living creatures.> ; Dex entry.

    db 203.0 ; Weight in kg.
    db 5.8 ; Height in meters.

    db YVELTAL, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
