    ...
    db 796 ; Dex number.
    db <One of the mysterious life-forms known as Ultra Beasts. Astonishing electric shocks emanate from its entire body, according to witnesses.> ; Dex entry.

    db 100.0 ; Weight in kg.
    db 3.8 ; Height in meters.

    db XURKITREE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
