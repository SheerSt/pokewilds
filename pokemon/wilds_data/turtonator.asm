    ...
    db 776 ; Dex number.
    db <Explosive substances coat the shell on its back. Enemies that dare attack it will be blown away by an immense detonation.> ; Dex entry.

    db 212.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db TURTONATOR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
