    ...
    db 482 ; Dex number.
    db <Known as �The Being of Willpower.� It sleeps at the bottom of a lake to keep the world in balance.> ; Dex entry.

    db 0.3 ; Weight in kg.
    db 0.3 ; Height in meters.

    db AZELF 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
