    ...
    db 140 ; Dex number.
    db <Kabuto is a Pok�mon that has been regenerated from a fossil. However, in extremely rare cases, living examples have been discovered. The Pok�mon has not changed at all for 300 million years.> ; Dex entry.
