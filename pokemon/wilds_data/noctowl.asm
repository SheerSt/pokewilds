    ...
    db 164 ; Dex number.
    db <Its eyes are specially developed to enable it to see clearly even in murky darkness and minimal light.> ; Dex entry.

    db 40.8 ; Weight in kg.
    db 1.6 ; Height in meters.

    db HOOTHOOT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
