    ...
    db 232 ; Dex number.
    db <Donphan's favorite attack is curling its body into a ball, then charging at its foe while rolling at high speed. Once it starts rolling, this Pok�mon can't stop very easily.> ; Dex entry.
