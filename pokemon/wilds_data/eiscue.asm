    ...
    db 875 ; Dex number.
    db <It drifted in on the flow of ocean waters from a frigid place. It keeps its head iced constantly to make sure it stays nice and cold.> ; Dex entry.

    db 89.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db EISCUE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
