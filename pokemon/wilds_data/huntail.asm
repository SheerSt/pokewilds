    ...
    db 367 ; Dex number.
    db <Huntail's presence went unnoticed by people for a long time because it lives at extreme depths in the sea. This Pok�mon's eyes can see clearly even in the murky dark depths of the ocean.> ; Dex entry.

    db 27.0 ; Weight in kg.
