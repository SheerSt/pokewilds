    ...
    db 530 ; Dex number.
    db <It's not uncommon for tunnels that appear to have formed naturally to actually be a result of Excadrill's rampant digging.> ; Dex entry.

    db 40.4 ; Weight in kg.
    db 0.7 ; Height in meters.

    db DRILBUR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
