    ...
    db 550 ; Dex number.
    db <Anglers love the fight this Pok�mon puts up on the hook. And there are always more to catch� many people release them into lakes illicitly.> ; Dex entry.

    db 18.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db BASCULIN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
