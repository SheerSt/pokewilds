    ...
    db 22 ; Dex number.
    db <It's tough and has excellent stamina. It has no problem flying continuously for a whole day carrying a heavy load.> ; Dex entry.

    db 38.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db SPEAROW 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
