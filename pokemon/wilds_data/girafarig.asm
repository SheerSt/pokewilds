    ...
    db 203 ; Dex number.
    db <Girafarig's rear head also has a brain, but it is small. The rear head attacks in response to smells and sounds. Approaching this Pok�mon from behind can cause the rear head to suddenly lash out and bite.> ; Dex entry.

    db 41.5 ; Weight in kg.
    db 1.5 ; Height in meters.

    db GIRAFARIG 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
