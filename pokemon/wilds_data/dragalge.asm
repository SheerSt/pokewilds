    ...
    db 691 ; Dex number.
    db <Dragalge uses a poisonous liquid capable of corroding metal to send tankers that enter its territory to the bottom of the sea.> ; Dex entry.

    db 81.5 ; Weight in kg.
    db 1.8 ; Height in meters.

    db SKRELP 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
