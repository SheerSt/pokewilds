    ...
    db 897 ; Dex number.
    db <It probes its surroundings with all its senses save one�it doesn't use its sense of sight. Spectrier's kicks are said to separate soul from body.> ; Dex entry.

    db 44.5 ; Weight in kg.
    db 2.0 ; Height in meters.

    db SPECTRIER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
