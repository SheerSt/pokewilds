    ...
    db 738 ; Dex number.
    db <It builds up electricity in its abdomen, focuses it through its jaws, and then fires the electricity off in concentrated beams.> ; Dex entry.

    db 45.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db GRUBBIN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
