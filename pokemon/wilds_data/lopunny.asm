    ...
    db 428 ; Dex number.
    db <Lopunny is constantly monitoring its surroundings. If danger approaches, this Pokémon responds with superdestructive kicks.> ; Dex entry.

    db 33.3 ; Weight in kg.
    db 1.2 ; Height in meters.

    db BUNEARY, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
