    ...
    db 746 ; Dex number.
    db <Individually, they're incredibly weak. It's by gathering up into schools that they're able to confront opponents.> ; Dex entry.

    db 78.6 ; Weight in kg.
    db 0.2 ; Height in meters.

    db WISHIWASHI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
