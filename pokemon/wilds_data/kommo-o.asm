    ...
    db 784 ; Dex number.
    db <It clatters its tail scales to unnerve opponents. This Pok�mon will battle only those who stand steadfast in the face of this display.> ; Dex entry.

    db 78.2 ; Weight in kg.
    db 1.6 ; Height in meters.

    db HAKAMO_O 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
