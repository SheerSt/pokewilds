    ...
    db 416 ; Dex number.
    db <It skillfully commands its grubs in battles with its enemies. The grubs are willing to risk their lives to defend Vespiquen.> ; Dex entry.

    db 38.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db COMBEE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
