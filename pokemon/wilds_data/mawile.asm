    ...
    db 303 ; Dex number.
    db <It uses its docile-looking face to lull foes into complacency, then bites with its huge, relentless jaws.> ; Dex entry.

    db 11.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db MAWILE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
