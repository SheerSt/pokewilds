    ...
    db 628 ; Dex number.
    db <Known for its bravery and pride, this majestic Pok�mon is often seen as a motif for various kinds of emblems.> ; Dex entry.

    db 41.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db RUFFLET 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
