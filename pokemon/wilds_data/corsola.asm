    ...
    db 222 ; Dex number.
    db <It will regrow any branches that break off its head. People keep particularly beautiful Corsola branches as charms to promote safe childbirth.> ; Dex entry.

    db 5.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db CORSOLA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db TIDAL_BEACH_ROCKS TIDAL_BEACH_ROCKS TIDAL_BEACH_ROCKS TIDAL_BEACH_ROCKS TIDAL_BEACH_PLATEAU TIDAL_BEACH_PLATEAU TIDAL_BEACH_PLATEAU TIDAL_BEACH_PLATEAU OCEAN_FISHING ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
