    ...
    db 10 ; Dex number.
    db <For protection, it releases a horrible stench from the antenna on its head to drive away enemies.> ; Dex entry.

    db 2.9 ; Weight in kg.
    db 0.3 ; Height in meters.

    db CATERPIE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
