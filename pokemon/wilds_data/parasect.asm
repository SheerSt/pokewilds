    ...
    db 47 ; Dex number.
    db <The large mushroom on its back controls it. It often fights over territory with Shiinotic.> ; Dex entry.

    db 29.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db PARAS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
