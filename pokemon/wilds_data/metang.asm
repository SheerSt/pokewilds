    ...
    db 375 ; Dex number.
    db <When two Beldum link together, their psychic power is doubled. Their intelligence, however, remains unchanged.> ; Dex entry.

    db 202.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db BELDUM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
