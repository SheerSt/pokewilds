    ...
    db 839 ; Dex number.
    db <Its body is a colossal stove. With Gigantamax energy stoking the fire, this Pokémon's flame burns hotter than 3,600 degrees Fahrenheit.> ; Dex entry.

    db 310.5 ; Weight in kg.
    db 2.8 ; Height in meters.

    db ROLYCOLY 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
