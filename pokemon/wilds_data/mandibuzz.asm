    ...
    db 630 ; Dex number.
    db <Although it's a bit of a ruffian, this Pokémon will take lost Vullaby under its wing and care for them till they're ready to leave the nest.> ; Dex entry.

    db 39.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db VULLABY 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
