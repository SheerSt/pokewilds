    ...
    db 143 ; Dex number.
    db <Gigantamax energy has affected stray seeds and even pebbles that got stuck to Snorlax, making them grow to a huge size.> ; Dex entry.

    db 460.0 ; Weight in kg.
