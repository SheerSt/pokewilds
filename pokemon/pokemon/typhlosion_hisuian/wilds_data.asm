    db TYPHLOSION ; Display name (DEFAULT for default name).

    db 157 ; Dex number.
    db <Typhlosion obscures itself behind a shimmering heat haze that it creates using its intensely hot flames. This Pokémon creates blazing explosive blasts that burn everything to cinders.> ; Dex entry.

    db 79.5 ; Weight in kg.
    db 1.7 ; Height in meters.

    db CYNDAQUIL 100 ; Base form(s) (MON_NAME for base species, then chance).
