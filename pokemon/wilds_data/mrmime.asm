    ...
    db 122 ; Dex number.
    db <Its talent is tap-dancing. It can also manipulate temperatures to create a floor of ice, which this Pok�mon can kick up to use as a barrier.> ; Dex entry.

    db 54.5 ; Weight in kg.
    db 1.3 ; Height in meters.

    db MIME_JR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
