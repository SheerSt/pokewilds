    ...
    db 146 ; Dex number.
    db <Moltres is a legendary bird Pok�mon that has the ability to control fire. If this Pok�mon is injured, it is said to dip its body in the molten magma of a volcano to burn and heal itself.> ; Dex entry.

    db 60.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db MOLTRES 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
