    ...
    db 649 ; Dex number.
    db <This ancient bug Pok�mon was altered by Team Plasma. They upgraded the cannon on its back.> ; Dex entry.

    db 82.5 ; Weight in kg.
    db 1.5 ; Height in meters.

    db GENESECT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
