    ...
    db 610 ; Dex number.
    db <These Pokémon nest in the ground and use their tusks to crush hard berries. Crushing berries is also how they test each other's strength.> ; Dex entry.

    db 18.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db AXEW, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
