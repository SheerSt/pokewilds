    ...
    db 526 ; Dex number.
    db <This hardy Pokémon can often be found on construction sites and in mines, working alongside people and Copperajah.> ; Dex entry.

    db 260.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db ROGGENROLA, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
