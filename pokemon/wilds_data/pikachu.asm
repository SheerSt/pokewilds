    ...
    db 25 ; Dex number.
    db <Its Gigantamax power expanded, forming its supersized body and towering tail.> ; Dex entry.

    db 6.0 ; Weight in kg.
    db 0.4 ; Height in meters.

    db PICHU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
