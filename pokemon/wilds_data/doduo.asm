    ...
    db 84 ; Dex number.
    db <Doduo's two heads never sleep at the same time. Its two heads take turns sleeping, so one head can always keep watch for enemies while the other one sleeps.> ; Dex entry.

    db 39.2 ; Weight in kg.
    db 1.4 ; Height in meters.

    db DODUO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
