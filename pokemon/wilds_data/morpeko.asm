    ...
    db 877 ; Dex number.
    db <As it eats the seeds stored up in its pocket-like pouches, this Pokémon is not just satisfying its constant hunger. It's also generating electricity.> ; Dex entry.

    db 3.0 ; Weight in kg.
    db 0.3 ; Height in meters.

    db MORPEKO 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
