    ...
    db 200 ; Dex number.
    db <It will use any means necessary to frighten people and absorb their life energy. It practices constantly to hone its skill in causing fear.> ; Dex entry.

    db 1.0 ; Weight in kg.
    db 0.7 ; Height in meters.

    db MISDREAVUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
