    ...
    db 727 ; Dex number.
    db <It excels at violent, no-holds-barred battles. The temperature of the flames that issue from its navel exceeds 3,600 degrees Fahrenheit.> ; Dex entry.

    db 83.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db LITTEN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
