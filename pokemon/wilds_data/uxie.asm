    ...
    db 480 ; Dex number.
    db <Known as �The Being of Knowledge.� It is said that it can wipe out the memory of those who see its eyes.> ; Dex entry.

    db 0.3 ; Weight in kg.
    db 0.3 ; Height in meters.

    db UXIE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
