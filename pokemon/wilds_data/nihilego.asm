    ...
    db 793 ; Dex number.
    db <One of several mysterious Ultra Beasts. People on the street report observing those infested by it suddenly becoming violent.> ; Dex entry.

    db 55.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db NIHILEGO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
