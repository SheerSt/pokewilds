    ...
    db 641 ; Dex number.
    db <The lower half of its body is wrapped in a cloud of energy. It zooms through the sky at 200 mph.> ; Dex entry.

    db 63.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db TORNADUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
