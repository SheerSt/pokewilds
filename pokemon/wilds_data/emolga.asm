    ...
    db 587 ; Dex number.
    db <As Emolga flutters through the air, it crackles with electricity. This Pok�mon is cute, but it can cause a lot of trouble.> ; Dex entry.

    db 5.0 ; Weight in kg.
    db 0.4 ; Height in meters.

    db EMOLGA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
