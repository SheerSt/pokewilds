    ...
    db 487 ; Dex number.
    db <This Pok�mon is said to live in a world on the reverse side of ours, where common knowledge is distorted and strange.> ; Dex entry.

    db 750.0 ; Weight in kg.
    db 4.5 ; Height in meters.

    db GIRATINA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
