    ...
    db 228 ; Dex number.
    db <Houndour hunt as a coordinated pack. They communicate with each other using a variety of cries to corner their prey. This Pok�mon's remarkable teamwork is unparalleled.> ; Dex entry.

    db 10.8 ; Weight in kg.
    db 0.6 ; Height in meters.

    db HOUNDOUR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db DEEP_FOREST GRAVEYARD ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
