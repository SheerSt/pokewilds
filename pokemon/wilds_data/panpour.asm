    ...
    db 515 ; Dex number.
    db <The water stored inside the tuft on its head is full of nutrients. It waters plants with it using its tail.> ; Dex entry.

    db 13.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db PANPOUR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
