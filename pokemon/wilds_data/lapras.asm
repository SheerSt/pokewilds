    ...
    db 131 ; Dex number.
    db <A smart and kindhearted Pok�mon, it glides across the surface of the sea while its beautiful song echoes around it.> ; Dex entry.

    db 220.0 ; Weight in kg.
    db 2.5 ; Height in meters.

    db LAPRAS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
    ...
    db 5 ; Water offset for OW sprites, in pixels.