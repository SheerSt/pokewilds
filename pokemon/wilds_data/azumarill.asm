    ...
    db 184 ; Dex number.
    db <It spends most of its time in the water. On sunny days, Azumarill floats on the surface of the water and sunbathes.> ; Dex entry.

    db 28.5 ; Weight in kg.
    db 0.8 ; Height in meters.

    db AZURILL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
