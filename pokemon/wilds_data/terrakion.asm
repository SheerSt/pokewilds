    ...
    db 639 ; Dex number.
    db <Its charge is strong enough to break through a giant castle wall in one blow. This Pok�mon is spoken of in legends.> ; Dex entry.

    db 260.0 ; Weight in kg.
    db 1.9 ; Height in meters.

    db TERRAKION 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
