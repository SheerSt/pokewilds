    ...
    db 56 ; Dex number.
    db <It can spontaneously become enraged. Everyone near it clears out as it rampages, and the resulting loneliness makes it angrier still.> ; Dex entry.

    db 28.0 ; Weight in kg.
    db 0.5 ; Height in meters.

    db MANKEY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
