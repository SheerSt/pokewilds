    ...
    db 598 ; Dex number.
    db <This Pokémon scrapes its spikes across rocks, and then uses the tips of its feelers to absorb the nutrients it finds within the stone.> ; Dex entry.

    db 110.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db FERROSEED 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
