    ...
    db 625 ; Dex number.
    db <It's accompanied by a large retinue of Pawniard. Bisharp keeps a keen eye on its minions, ensuring none of them even think of double-crossing it.> ; Dex entry.

    db 70.0 ; Weight in kg.
    db 1.6 ; Height in meters.

    db PAWNIARD 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
