    ...
    db 265 ; Dex number.
    db <Using the spikes on its rear end, Wurmple peels the bark off trees and feeds on the sap that oozes out. This Pok�mon's feet are tipped with suction pads that allow it to cling to glass without slipping.> ; Dex entry.
