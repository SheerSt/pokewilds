    ...
    db 699 ; Dex number.
    db <The diamond-shaped crystals on its body expel air as cold as -240 degrees Fahrenheit, surrounding its enemies and encasing them in ice.> ; Dex entry.

    db 225.0 ; Weight in kg.
    db 2.7 ; Height in meters.

    db AMAURA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
