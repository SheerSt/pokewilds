    ...
    db 331 ; Dex number.
    db <Cacnea lives in arid locations such as deserts. It releases a strong aroma from its flower to attract prey. When prey comes near, this Pok�mon shoots sharp thorns from its body to bring the victim down.> ; Dex entry.

    db 51.3 ; Weight in kg.
    db 0.4 ; Height in meters.

    db CACNEA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
