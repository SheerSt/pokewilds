    db TYPE: NULL ; Display name (DEFAULT for default name).

    db 772 ; Dex number.
    db <Rumor has it that the theft of top-secret research notes led to a new instance of this Pokémon being created in the Galar region.> ; Dex entry.

    db 120.5 ; Weight in kg.
    db 1.9 ; Height in meters.

    db TYPE_NULL 100 ; Base form(s) (MON_NAME for base species, then chance).
