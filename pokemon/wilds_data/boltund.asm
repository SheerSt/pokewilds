    ...
    db 836 ; Dex number.
    db <This Pok�mon generates electricity and channels it into its legs to keep them going strong. Boltund can run nonstop for three full days.> ; Dex entry.

    db 34.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db YAMPER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
