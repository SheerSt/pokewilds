    ...
    db 663 ; Dex number.
    db <Talonflame mainly preys upon other bird Pokémon. To intimidate opponents, it sends embers spewing from gaps between its feathers.> ; Dex entry.

    db 24.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db FLETCHLING 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
