    ...
    db 818 ; Dex number.
    db <Gigantamax Inteleon's Water Gun move fires at Mach 7. As the Pok�mon takes aim, it uses the crest on its head to gauge wind and temperature.> ; Dex entry.

    db 45.2 ; Weight in kg.
    db 1.9 ; Height in meters.

    db SOBBLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
