    ...
    db 441 ; Dex number.
    db <It mimics the cries of other Pok�mon to trick them into thinking it's one of them. This way they won't attack it.> ; Dex entry.

    db 1.9 ; Weight in kg.
    db 0.5 ; Height in meters.

    db CHATOT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
