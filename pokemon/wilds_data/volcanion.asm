    ...
    db 721 ; Dex number.
    db <It lets out billows of steam and disappears into the dense fog. It's said to live in mountains where humans do not tread.> ; Dex entry.

    db 195.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db VOLCANION 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
