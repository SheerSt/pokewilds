    ...
    db 666 ; Dex number.
    db <Vivillon with many different patterns are found all over the world. These patterns are affected by the climate of their habitat.> ; Dex entry.

    db 17.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db SCATTERBUG 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
