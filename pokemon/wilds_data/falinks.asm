    ...
    db 870 ; Dex number.
    db <Five of them are troopers, and one is the brass. The brass's orders are absolute.> ; Dex entry.

    db 62.0 ; Weight in kg.
    db 3.0 ; Height in meters.

    db FALINKS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
