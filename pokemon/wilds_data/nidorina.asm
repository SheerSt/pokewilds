    ...
    db 30 ; Dex number.
    db <When Nidorina are with their friends or family, they keep their barbs tucked away to prevent hurting each other. This Pok�mon appears to become nervous if separated from the others.> ; Dex entry.
