    ...
    db 592 ; Dex number.
    db <It envelops its prey in its veillike arms and draws it down to the deeps, five miles below the ocean's surface.> ; Dex entry.

    db 33.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db FRILLISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
