    ...
    db 244 ; Dex number.
    db <Entei embodies the passion of magma. This Pokémon is thought to have been born in the eruption of a volcano. It sends up massive bursts of fire that utterly consume all that they touch.> ; Dex entry.

    db 198.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db ENTEI, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
