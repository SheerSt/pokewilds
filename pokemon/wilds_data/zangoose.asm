    ...
    db 335 ; Dex number.
    db <Memories of battling its archrival Seviper are etched into every cell of Zangoose's body. This Pok�mon adroitly dodges attacks with incredible agility.> ; Dex entry.

    db 40.3 ; Weight in kg.
    db 1.3 ; Height in meters.

    db ZANGOOSE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
