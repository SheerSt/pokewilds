    ...
    db 404 ; Dex number.
    db <By joining its tail with that of another Luxio, this Pok�mon can receive some of the other Luxio's electricity and power up its own electric blasts.> ; Dex entry.

    db 30.5 ; Weight in kg.
