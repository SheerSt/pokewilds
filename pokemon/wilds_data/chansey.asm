    ...
    db 113 ; Dex number.
    db <The egg Chansey carries is not only delicious but also packed with nutrition. It's used as a high-class cooking ingredient.> ; Dex entry.

    db 34.6 ; Weight in kg.
