    ...
    db 567 ; Dex number.
    db <Although apparently able to fly, they tended to run along the ground, averaging speeds of roughly 25 mph.> ; Dex entry.

    db 32.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db ARCHEN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
