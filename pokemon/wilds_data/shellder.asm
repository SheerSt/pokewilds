    ...
    db 90 ; Dex number.
    db <It swims facing backward by opening and closing its two-piece shell. It is surprisingly fast.> ; Dex entry.

    db 4.0 ; Weight in kg.
    db 0.3 ; Height in meters.

    db SHELLDER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
