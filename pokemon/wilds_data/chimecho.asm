    ...
    db 358 ; Dex number.
    db <Chimecho makes its cries echo inside its hollow body. When this Pok�mon becomes enraged, its cries result in ultrasonic waves that have the power to knock foes flying.> ; Dex entry.
