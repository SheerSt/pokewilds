    ...
    db 106 ; Dex number.
    db <This amazing Pok�mon has an awesome sense of balance. It can kick in succession from any position.> ; Dex entry.

    db 49.8 ; Weight in kg.
    db 1.5 ; Height in meters.

    db TYROGUE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
