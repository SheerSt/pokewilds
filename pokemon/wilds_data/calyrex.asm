    ...
    db 898 ; Dex number.
    db <Calyrex is a merciful Pokémon, capable of providing healing and blessings. It reigned over the Galar region in times of yore.> ; Dex entry.

    db 7.7 ; Weight in kg.
    db 1.1 ; Height in meters.

    db CALYREX, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
