    ...
    db 754 ; Dex number.
    db <This Pok�mon resembles a beautiful flower. A properly raised Lurantis will have gorgeous, brilliant colors.> ; Dex entry.

    db 18.5 ; Weight in kg.
    db 0.9 ; Height in meters.

    db FOMANTIS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
