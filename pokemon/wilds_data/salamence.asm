    ...
    db 373 ; Dex number.
    db <When angered, it loses all sense of itself and destroys everything around it. The destruction will continue until Salamence has tired itself out.> ; Dex entry.

    db 102.6 ; Weight in kg.
    db 1.5 ; Height in meters.

    db BAGON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
