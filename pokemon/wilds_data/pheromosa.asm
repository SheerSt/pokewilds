    ...
    db 795 ; Dex number.
    db <One of the dangerous Ultra Beasts, it has been spotted running across the land at terrific speeds.> ; Dex entry.

    db 25.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db PHEROMOSA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
