    ...
    db 391 ; Dex number.
    db <It skillfully controls the intensity of the fire on its tail to keep its foes at an ideal distance.> ; Dex entry.

    db 22.0 ; Weight in kg.
    db 0.9 ; Height in meters.

    db CHIMCHAR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
