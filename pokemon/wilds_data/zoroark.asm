    ...
    db 571 ; Dex number.
    db <This Pok�mon cares deeply about others of its kind, and it will conjure terrifying illusions to keep its den and pack safe.> ; Dex entry.

    db 81.1 ; Weight in kg.
