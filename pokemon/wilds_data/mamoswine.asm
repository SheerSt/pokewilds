    ...
    db 473 ; Dex number.
    db <This Pok�mon can be spotted in wall paintings from as far back as 10,000 years ago. For a while, it was thought to have gone extinct.> ; Dex entry.

    db 291.0 ; Weight in kg.
    db 2.5 ; Height in meters.

    db SWINUB 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
