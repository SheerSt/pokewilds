    ...
    db 801 ; Dex number.
    db <This artificial Pokémon, constructed more than 500 years ago, can understand human speech but cannot itself speak.> ; Dex entry.

    db 80.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db MAGEARNA 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
