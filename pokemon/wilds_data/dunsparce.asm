    ...
    db 206 ; Dex number.
    db <This Pok�mon's tiny wings have some scientists saying that Dunsparce used to fly through the sky in ancient times.> ; Dex entry.

    db 14.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db DUNSPARCE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
