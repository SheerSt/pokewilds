    ...
    db 663 ; Dex number.
    db <Talonflame mainly preys upon other bird Pok�mon. To intimidate opponents, it sends embers spewing from gaps between its feathers.> ; Dex entry.

    db 24.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db FLETCHLING 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
