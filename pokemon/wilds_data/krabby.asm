    ...
    db 98 ; Dex number.
    db <It can be found near the sea. The large pincers grow back if they are torn out of their sockets.> ; Dex entry.

    db 6.5 ; Weight in kg.
    db 0.4 ; Height in meters.

    db KRABBY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db BEACH TIDAL_BEACH TIDAL_BEACH_ROCKS TIDAL_BEACH_PLATEAU ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
