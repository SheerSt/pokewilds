    ...
    db 880 ; Dex number.
    db <In ancient times, it was unbeatable thanks to its powerful lower body, but it went extinct anyway after it depleted all its plant-based food sources.> ; Dex entry.

    db 190.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db DRACOZOLT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
