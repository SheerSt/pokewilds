    ...
    db 325 ; Dex number.
    db <Spoink bounces around on its tail. The shock of its bouncing makes its heart pump. As a result, this Pok�mon cannot afford to stop bouncing�if it stops, its heart will stop.> ; Dex entry.

    db 30.6 ; Weight in kg.
