    ...
    db 381 ; Dex number.
    db <Latios has the ability to make others see an image of what it has seen or imagines in its head. This Pok�mon is intelligent and understands human speech.> ; Dex entry.

    db 60.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db LATIOS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
