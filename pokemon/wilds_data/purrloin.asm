    ...
    db 509 ; Dex number.
    db <It steals things from people just to amuse itself with their frustration. A rivalry exists between this Pok�mon and Nickit.> ; Dex entry.

    db 10.1 ; Weight in kg.
    db 0.4 ; Height in meters.

    db PURRLOIN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
