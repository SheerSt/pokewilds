    ...
    db 88 ; Dex number.
    db <Its main source of food is the slimy industrial waste of factories. This Pok�mon's numbers have been decreasing in recent years.> ; Dex entry.

    db 30.0 ; Weight in kg.
    db 0.9 ; Height in meters.

    db GRIMER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db PKMNMANSION ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
