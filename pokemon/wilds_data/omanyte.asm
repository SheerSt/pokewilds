    ...
    db 138 ; Dex number.
    db <Omanyte is one of the ancient and long-since-extinct Pok�mon that have been regenerated from fossils by people. If attacked by an enemy, it withdraws itself inside its hard shell.> ; Dex entry.
