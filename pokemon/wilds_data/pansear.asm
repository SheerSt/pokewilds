    ...
    db 513 ; Dex number.
    db <Very intelligent, it roasts berries before eating them. It likes to help people.> ; Dex entry.

    db 11.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db PANSEAR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
