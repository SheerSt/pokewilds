    ...
    db 344 ; Dex number.
    db <This mysterious Pok�mon started life as an ancient clay figurine made over 20,000 years ago.> ; Dex entry.

    db 108.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db BALTOY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
