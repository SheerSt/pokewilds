    ...
    db 882 ; Dex number.
    db <Powerful legs and jaws made it the apex predator of its time. Its own overhunting of its prey was what drove it to extinction.> ; Dex entry.

    db 215.0 ; Weight in kg.
    db 2.3 ; Height in meters.

    db DRACOVISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
