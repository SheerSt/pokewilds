    ...
    db 486 ; Dex number.
    db <It is said to have made Pok�mon that look like itself from a special ice mountain, rocks, and magma.> ; Dex entry.

    db 420.0 ; Weight in kg.
    db 3.7 ; Height in meters.

    db REGIGIGAS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
