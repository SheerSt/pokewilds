    ...
    db 723 ; Dex number.
    db <It throws one knifelike feather after another at its enemies, and each one precisely strikes a weak point. These feathers are known as blade quills.> ; Dex entry.

    db 16.0 ; Weight in kg.
    db 0.7 ; Height in meters.

    db ROWLET 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
