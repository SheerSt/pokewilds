    ...
    db 9 ; Dex number.
    db <It crushes its foe under its heavy body to cause fainting. In a pinch, it will withdraw inside its shell.> ; Dex entry.

    db 85.5 ; Weight in kg.
    db 1.6 ; Height in meters.

    db SQUIRTLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
