    ...
    db 491 ; Dex number.
    db <It chases people and Pok�mon from its territory by causing them to experience deep, nightmarish slumbers.> ; Dex entry.

    db 50.5 ; Weight in kg.
    db 1.5 ; Height in meters.

    db DARKRAI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
