    ...
    db 151 ; Dex number.
    db <Mew is said to possess the genetic composition of all Pokémon. It is capable of making itself invisible at will, so it entirely avoids notice even if it approaches people.> ; Dex entry.

    db 4.0 ; Weight in kg.
    db 0.4 ; Height in meters.

    db MEW 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
