    ...
    db 896 ; Dex number.
    db <Glastrier emits intense cold from its hooves. It's also a belligerent Pok�mon�anything it wants, it takes by force.> ; Dex entry.

    db 800.0 ; Weight in kg.
    db 2.2 ; Height in meters.

    db GLASTRIER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
