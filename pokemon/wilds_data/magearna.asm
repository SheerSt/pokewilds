    ...
    db 801 ; Dex number.
    db <This artificial Pok�mon, constructed more than 500 years ago, can understand human speech but cannot itself speak.> ; Dex entry.

    db 80.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db MAGEARNA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
