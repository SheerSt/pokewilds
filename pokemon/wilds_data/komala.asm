    ...
    db 775 ; Dex number.
    db <It is born asleep, and it dies asleep. All its movements are apparently no more than the results of it tossing and turning in its dreams.> ; Dex entry.

    db 19.9 ; Weight in kg.
    db 0.4 ; Height in meters.

    db KOMALA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
