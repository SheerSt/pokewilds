    ...
    db 729 ; Dex number.
    db <As if dancing, it artfully dodges the attacks of its enemies. All the while, it's busy forming a bunch of balloons to overwhelm its foes.> ; Dex entry.

    db 17.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db POPPLIO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
