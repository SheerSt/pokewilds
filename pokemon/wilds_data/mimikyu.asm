    ...
    db 778 ; Dex number.
    db <It wears a rag fashioned into a Pikachu costume in an effort to look less scary. Unfortunately, the costume only makes it creepier.> ; Dex entry.

    db 0.7 ; Weight in kg.
    db 0.2 ; Height in meters.

    db MIMIKYU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
