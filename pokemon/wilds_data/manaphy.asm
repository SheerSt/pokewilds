    ...
    db 490 ; Dex number.
    db <It is born with a wondrous power that lets it bond with any kind of Pok�mon.> ; Dex entry.

    db 1.4 ; Weight in kg.
    db 0.3 ; Height in meters.

    db MANAPHY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
