    ...
    db 227 ; Dex number.
    db <The pointed feathers of these Pok�mon are sharper than swords. Skarmory and Corviknight fight viciously over territory.> ; Dex entry.

    db 50.5 ; Weight in kg.
    db 1.7 ; Height in meters.

    db SKARMORY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
