    ...
    db 718 ; Dex number.
    db <This is Zygarde's form when it has gathered 50% of its cells. It wipes out all those who oppose it, showing not a shred of mercy.> ; Dex entry.

    db 33.5 ; Weight in kg.
    db 5.0 ; Height in meters.

    db ZYGARDE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
