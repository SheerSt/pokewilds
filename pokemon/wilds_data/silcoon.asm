    ...
    db 266 ; Dex number.
    db <Silcoon tethers itself to a tree branch using silk to keep from falling. There, this Pokémon hangs quietly while it awaits evolution. It peers out of the silk cocoon through a small hole.> ; Dex entry.

    db 10.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db WURMPLE, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
