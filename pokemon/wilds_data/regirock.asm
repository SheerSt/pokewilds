    ...
    db 377 ; Dex number.
    db <Regirock was sealed away by people long ago. If this Pok�mon's body is damaged in battle, it is said to seek out suitable rocks on its own to repair itself.> ; Dex entry.

    db 230.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db REGIROCK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
