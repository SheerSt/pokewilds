    ...
    db 86 ; Dex number.
    db <Seel hunts for prey in the frigid sea underneath sheets of ice. When it needs to breathe, it punches a hole through the ice with the sharply protruding section of its head.> ; Dex entry.

    db 90.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db SEEL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
