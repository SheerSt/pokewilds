    ...
    db 110 ; Dex number.
    db <It mixes gases between its two bodies. It's said that these Pok�mon were seen all over the Galar region back in the day.> ; Dex entry.

    db 9.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db KOFFING 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
