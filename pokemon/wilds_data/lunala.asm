    ...
    db 792 ; Dex number.
    db <Known as the Beast That Calls the Moon, this Pok�mon lives by taking in any and all light and converting it into its own energy.> ; Dex entry.

    db 120.0 ; Weight in kg.
    db 4.0 ; Height in meters.
