    ...
    db 570 ; Dex number.
    db <Zorua is a timid Pok�mon. This disposition seems to be what led to the development of Zorua's ability to take on the forms of other creatures.> ; Dex entry.

    db 12.5 ; Weight in kg.
    db 0.7 ; Height in meters.

    db ZORUA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
