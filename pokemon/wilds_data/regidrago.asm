    ...
    db 895 ; Dex number.
    db <An academic theory proposes that Regidrago's arms were once the head of an ancient dragon Pok�mon. The theory remains unproven.> ; Dex entry.

    db 200.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db REGIDRAGO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
