    ...
    db 111 ; Dex number.
    db <Strong, but not too bright, this Pok�mon can shatter even a skyscraper with its charging tackles.> ; Dex entry.

    db 115.0 ; Weight in kg.
    ...
    db MOUNTAIN SAVANNA ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
