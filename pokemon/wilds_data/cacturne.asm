    ...
    db 332 ; Dex number.
    db <During the daytime, Cacturne remains unmoving so that it does not lose any moisture to the harsh desert sun. This Pok�mon becomes active at night when the temperature drops.> ; Dex entry.
