    ...
    db 340 ; Dex number.
    db <It makes its nest at the bottom of swamps. It will eat anything�if it is alive, Whiscash will eat it.> ; Dex entry.

    db 23.6 ; Weight in kg.
    db 0.9 ; Height in meters.

    db BARBOACH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
