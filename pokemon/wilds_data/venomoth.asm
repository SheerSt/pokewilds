    ...
    db 49 ; Dex number.
    db <Venomoth is nocturnal�it is a Pok�mon that only becomes active at night. Its favorite prey are small insects that gather around streetlights, attracted by the light in the darkness.> ; Dex entry.

    db 12.5 ; Weight in kg.
    db 1.5 ; Height in meters.

    db VENONAT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
