    ...
    db 350 ; Dex number.
    db <Milotic has provided inspiration to many artists. It has even been referred to as the most beautiful Pok�mon of all.> ; Dex entry.

    db 162.0 ; Weight in kg.
    db 6.2 ; Height in meters.

    db FEEBAS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
