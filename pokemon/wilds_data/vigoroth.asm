    ...
    db 288 ; Dex number.
    db <Vigoroth is always itching and agitated to go on a wild rampage. It simply can't tolerate sitting still for even a minute. This Pok�mon's stress level rises if it can't be moving constantly.> ; Dex entry.

    db 46.5 ; Weight in kg.
    db 1.4 ; Height in meters.

    db SLAKOTH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
