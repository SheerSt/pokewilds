    ...
    db 617 ; Dex number.
    db <It moves with blinding speed and lobs poison at foes. Featuring Accelgor as a main character is a surefire way to make a movie or comic popular.> ; Dex entry.

    db 25.3 ; Weight in kg.
    db 0.8 ; Height in meters.

    db SHELMET 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
