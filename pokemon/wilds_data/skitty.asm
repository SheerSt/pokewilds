    ...
    db 300 ; Dex number.
    db <Skitty has the habit of becoming fascinated by moving objects and chasing them around. This Pokémon is known to chase after its own tail and become dizzy.> ; Dex entry.
