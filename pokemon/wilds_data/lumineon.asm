    ...
    db 457 ; Dex number.
    db <With its shining light, it lures its prey close. However, the light also happens to attract ferocious fish Pok�mon�its natural predators.> ; Dex entry.

    db 24.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db FINNEON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
