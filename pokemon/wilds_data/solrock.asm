    ...
    db 338 ; Dex number.
    db <When it rotates itself, it gives off light similar to the sun, thus blinding its foes.> ; Dex entry.

    db 154.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db SOLROCK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
