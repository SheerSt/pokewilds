    ...
    db 522 ; Dex number.
    db <When thunderclouds cover the sky, it will appear. It can catch lightning with its mane and store the electricity.> ; Dex entry.

    db 29.8 ; Weight in kg.
    db 0.8 ; Height in meters.

    db BLITZLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
