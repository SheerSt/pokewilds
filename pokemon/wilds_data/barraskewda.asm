    ...
    db 847 ; Dex number.
    db <This Pokémon has a jaw that's as sharp as a spear and as strong as steel. Apparently Barraskewda's flesh is surprisingly tasty, too.> ; Dex entry.

    db 30.0 ; Weight in kg.
    db 1.3 ; Height in meters.

    db ARROKUDA 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
