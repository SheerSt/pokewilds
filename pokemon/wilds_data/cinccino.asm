    ...
    db 573 ; Dex number.
    db <Its body secretes oil that this Pok�mon spreads over its nest as a coating to protect it from dust. Cinccino won't tolerate even a speck of the stuff.> ; Dex entry.

    db 7.5 ; Weight in kg.
    db 0.5 ; Height in meters.

    db MINCCINO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
