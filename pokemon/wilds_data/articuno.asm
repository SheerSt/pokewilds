    ...
    db 144 ; Dex number.
    db <Articuno is a legendary bird Pok�mon that can control ice. The flapping of its wings chills the air. As a result, it is said that when this Pok�mon flies, snow will fall.> ; Dex entry.

    db 55.4 ; Weight in kg.
    db 1.7 ; Height in meters.

    db ARTICUNO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
