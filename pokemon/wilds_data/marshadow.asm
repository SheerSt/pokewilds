    ...
    db 802 ; Dex number.
    db <By slipping into the shadow of a martial arts master and copying their movements, this Pok�mon learned the ultimate techniques.> ; Dex entry.

    db 22.2 ; Weight in kg.
    db 0.7 ; Height in meters.

    db MARSHADOW 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
