    ...
    db 847 ; Dex number.
    db <This Pok�mon has a jaw that's as sharp as a spear and as strong as steel. Apparently Barraskewda's flesh is surprisingly tasty, too.> ; Dex entry.

    db 30.0 ; Weight in kg.
    db 1.3 ; Height in meters.

    db ARROKUDA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
