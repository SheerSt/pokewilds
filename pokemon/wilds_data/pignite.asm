    ...
    db 499 ; Dex number.
    db <The more it eats, the more fuel it has to make the fire in its stomach stronger. This fills it with even more power.> ; Dex entry.

    db 55.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db TEPIG 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
