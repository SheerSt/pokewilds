    ...
    db 150 ; Dex number.
    db <Mewtwo is a Pokémon that was created by genetic manipulation. However, even though the scientific power of humans created this Pokémon's body, they failed to endow Mewtwo with a compassionate heart.> ; Dex entry.

    db 122.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db MEWTWO 100 ; Base form(s) (MON_NAME for base species, then chance).
    ...
    db ANCIENTPOWDER TYPE ; Harvestable items (TYPE as the final argument to apply type-based default items).
