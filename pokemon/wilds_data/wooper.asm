    ...
    db 194 ; Dex number.
    db <This Pok�mon lives in cold water. It will leave the water to search for food when it gets cold outside.> ; Dex entry.

    db 8.5 ; Weight in kg.
    db 0.4 ; Height in meters.

    db WOOPER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db BEACH TIDAL_BEACH WOODED_LAKE WOODED_LAKE_WATER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
