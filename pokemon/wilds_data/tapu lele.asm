    ...
    db 786 ; Dex number.
    db <This guardian deity of Akala is guilelessly cruel. The fragrant aroma of flowers is the source of its energy.> ; Dex entry.

    db 18.6 ; Weight in kg.
    db 1.2 ; Height in meters.

    db TAPU LELE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
