    ...
    db 436 ; Dex number.
    db <It appears in ancient ruins. The pattern on its body doesn't come from any culture in the Galar region, so it remains shrouded in mystery.> ; Dex entry.

    db 60.5 ; Weight in kg.
    db 0.5 ; Height in meters.

    db BRONZOR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
