    db DARMANITAN ; Display name (DEFAULT for default name).

    db 555 ; Dex number.
    db <Anger has reignited its atrophied flame sac. This Pok�mon spews fire everywhere as it rampages indiscriminately.> ; Dex entry.

    db 0 ; Weight in kg.
    db 0 ; Height in meters.

    db DARUMAKA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
    ...
    db 1 ; Can move in the overworld (0 = can nove ; 1 = can't move).
