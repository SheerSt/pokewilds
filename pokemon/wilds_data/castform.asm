    ...
    db 351 ; Dex number.
    db <It changes its form depending on the weather. Changes in the temperature or humidity appear to affect its cellular structure.> ; Dex entry.

    db 0.8 ; Weight in kg.
    db 0.3 ; Height in meters.

    db CASTFORM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
