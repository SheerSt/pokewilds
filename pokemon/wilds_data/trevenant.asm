    ...
    db 709 ; Dex number.
    db <People fear it due to a belief that it devours any who try to cut down trees in its forest, but to the Pok�mon it shares its woods with, it's kind.> ; Dex entry.

    db 71.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db PHANTUMP 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
