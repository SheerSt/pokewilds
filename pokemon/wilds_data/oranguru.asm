    ...
    db 765 ; Dex number.
    db <With waves of its fan—made from leaves and its own fur—Oranguru skillfully gives instructions to other Pokémon.> ; Dex entry.

    db 76.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db ORANGURU 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
