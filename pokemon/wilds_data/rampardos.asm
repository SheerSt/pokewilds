    ...
    db 409 ; Dex number.
    db <The result of repeated headbutts is a skull grown thick and hard. However, its brain has shrunk in size compared with Cranidos's.> ; Dex entry.

    db 102.5 ; Weight in kg.
    db 1.6 ; Height in meters.

    db CRANIDOS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
