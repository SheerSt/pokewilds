    ...
    db 60 ; Dex number.
    db <For Poliwag, swimming is easier than walking. The swirl pattern on its belly is actually part of the Pok�mon's innards showing through the skin.> ; Dex entry.

    db 12.4 ; Weight in kg.
    db 0.6 ; Height in meters.

    db POLIWAG 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db MOUNTAIN_WATER WOODED_LAKE WOODED_LAKE_FISHING OASIS OASIS_POND RIVER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
