    ...
    db 105 ; Dex number.
    db <This Pokémon overcame its sorrow to evolve a sturdy new body. Marowak faces its opponents bravely, using a bone as a weapon.> ; Dex entry.

    db 0 ; Weight in kg.
    db 0 ; Height in meters.

    db CUBONE 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
