    ...
    db 707 ; Dex number.
    db <This Pokémon is constantly collecting keys. Entrust a Klefki with important keys, and the Pokémon will protect them no matter what.> ; Dex entry.

    db 3.0 ; Weight in kg.
    db 0.2 ; Height in meters.

    db KLEFKI 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
