    ...
    db 3 ; Dex number.
    db <In battle, this Pok�mon swings around two thick vines. If these vines slammed into a 10-story building, they could easily topple it.> ; Dex entry.

    db 100.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db BULBASAUR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
