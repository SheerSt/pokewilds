    ...
    db 368 ; Dex number.
    db <Gorebyss lives in the southern seas at extreme depths. Its body is built to withstand the enormous pressure of water at incredible depths. Because of this, this Pok�mon's body is unharmed by ordinary attacks.> ; Dex entry.

    db 22.6 ; Weight in kg.
    db 1.8 ; Height in meters.

    db CLAMPERL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
