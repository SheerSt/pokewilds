    ...
    db 737 ; Dex number.
    db <While its durable shell protects it from attacks, Charjabug strikes at enemies with jolts of electricity discharged from the tips of its jaws.> ; Dex entry.

    db 10.5 ; Weight in kg.
