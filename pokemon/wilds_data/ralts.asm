    ...
    db 280 ; Dex number.
    db <It is highly attuned to the emotions of people and Pok�mon. It hides if it senses hostility.> ; Dex entry.

    db 6.6 ; Weight in kg.
    db 0.4 ; Height in meters.

    db RALTS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db DEEP_FOREST WOODED_LAKE ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
