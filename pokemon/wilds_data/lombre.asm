    ...
    db 271 ; Dex number.
    db <It is nocturnal and becomes active at nightfall. It feeds on aquatic mosses that grow in the riverbed.> ; Dex entry.

    db 32.5 ; Weight in kg.
    db 1.2 ; Height in meters.

    db LOTAD 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
