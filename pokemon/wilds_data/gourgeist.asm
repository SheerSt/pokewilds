    ...
    db 711 ; Dex number.
    db <Eerie cries emanate from its body in the dead of night. The sounds are said to be the wails of spirits who are suffering in the afterlife.> ; Dex entry.

    db 12.5 ; Weight in kg.
    db 0.9 ; Height in meters.

    db PUMPKABOO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
