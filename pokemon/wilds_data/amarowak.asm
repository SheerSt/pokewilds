    db MAROWAK ; Display name (DEFAULT for default name).

    db 105 ; Dex number.
    db <This Pok�mon overcame its sorrow to evolve a sturdy new body. Marowak faces its opponents bravely, using a bone as a weapon.> ; Dex entry.

    db 0 ; Weight in kg.
    db 0 ; Height in meters.

    db CUBONE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
