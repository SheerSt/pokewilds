    ...
    db 314 ; Dex number.
    db <Illumise attracts a swarm of Volbeat using a sweet fragrance. Once the Volbeat have gathered, this Pok�mon leads the lit-up swarm in drawing geometric designs on the canvas of the night sky.> ; Dex entry.

    db 17.7 ; Weight in kg.
    db 0.6 ; Height in meters.

    db ILLUMISE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
