    ...
    db 669 ; Dex number.
    db <It draws out and controls the hidden power of flowers. The flower Flabï¿½bï¿½ holds is most likely part of its body.> ; Dex entry.

    db 0.1 ; Weight in kg.
    db 0.1 ; Height in meters.

    db FLABÉBÉ 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
