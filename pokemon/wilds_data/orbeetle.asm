    ...
    db 826 ; Dex number.
    db <Its brain has grown to a gargantuan size, as has the rest of its body. This Pok�mon's intellect and psychic abilities are overpowering.> ; Dex entry.

    db 40.8 ; Weight in kg.
    db 0.4 ; Height in meters.

    db BLIPBUG 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
