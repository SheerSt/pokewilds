    ...
    db 620 ; Dex number.
    db <When Mienshao comes across a truly challenging opponent, it will lighten itself by biting off the fur on its arms.> ; Dex entry.

    db 35.5 ; Weight in kg.
    db 1.4 ; Height in meters.

    db MIENFOO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
