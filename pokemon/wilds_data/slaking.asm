    ...
    db 289 ; Dex number.
    db <Slaking spends all day lying down and lolling about. It eats grass growing within its reach. If it eats all the grass it can reach, this Pok�mon reluctantly moves to another spot.> ; Dex entry.

    db 130.5 ; Weight in kg.
