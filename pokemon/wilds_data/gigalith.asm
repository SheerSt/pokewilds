    ...
    db 526 ; Dex number.
    db <This hardy Pok�mon can often be found on construction sites and in mines, working alongside people and Copperajah.> ; Dex entry.

    db 260.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db ROGGENROLA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
