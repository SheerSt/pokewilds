    ...
    db 71 ; Dex number.
    db <Victreebel has a long vine that extends from its head. This vine is waved and flicked about as if it were an animal to attract prey. When an unsuspecting prey draws near, this Pokémon swallows it whole.> ; Dex entry.

    db 15.5 ; Weight in kg.
    db 1.7 ; Height in meters.

    db BELLSPROUT, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
