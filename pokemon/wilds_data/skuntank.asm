    ...
    db 435 ; Dex number.
    db <In its belly, it reserves stinky fluid that it shoots from its tail during battle. As this Pok�mon's diet varies, so does the stench of its fluid.> ; Dex entry.

    db 38.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db STUNKY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
