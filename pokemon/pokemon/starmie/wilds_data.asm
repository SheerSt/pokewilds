    ...
    db 121 ; Dex number.
    db <This Pokémon has an organ known as its core. The organ glows in seven colors when Starmie is unleashing its potent psychic powers.> ; Dex entry.

    db 80.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db STARYU 100 ; Base form(s) (MON_NAME for base species, then chance).
    ...
    db STAR_PIECE STAR_PIECE TYPE ; Harvestable items (TYPE as the final argument to apply type-based default items).
