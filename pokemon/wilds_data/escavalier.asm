    ...
    db 589 ; Dex number.
    db <They use shells they've stolen from Shelmet to arm and protect themselves. They're very popular Pok�mon in the Galar region.> ; Dex entry.

    db 33.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db KARRABLAST 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
