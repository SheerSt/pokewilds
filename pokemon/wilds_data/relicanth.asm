    ...
    db 369 ; Dex number.
    db <Its form has remained the same for one hundred million years. Its body is filled with fat, so it can withstand the water pressure of the deep sea.> ; Dex entry.

    db 23.4 ; Weight in kg.
    db 1.0 ; Height in meters.

    db RELICANTH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
