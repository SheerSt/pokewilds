    ...
    db 883 ; Dex number.
    db <Though it's able to capture prey by freezing its surroundings, it has trouble eating the prey afterward because its mouth is on top of its head.> ; Dex entry.

    db 175.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db ARCTOVISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
