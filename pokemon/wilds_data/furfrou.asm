    ...
    db 676 ; Dex number.
    db <Trimming its fluffy fur not only makes it more elegant but also increases the swiftness of its movements.> ; Dex entry.

    db 28.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db FURFROU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
