    ...
    db 851 ; Dex number.
    db <Gigantamax energy has evoked a rise in its body temperature, now reaching over 1,800 degrees Fahrenheit. Its heat waves incinerate its enemies.> ; Dex entry.

    db 120.0 ; Weight in kg.
    db 3.0 ; Height in meters.

    db SIZZLIPEDE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
