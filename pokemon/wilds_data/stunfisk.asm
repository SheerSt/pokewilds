    ...
    db 618 ; Dex number.
    db <Living in mud with a high iron content has given it a strong steel body.> ; Dex entry.

    db 11.0 ; Weight in kg.
    db 0.7 ; Height in meters.

    db STUNFISK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
