    ...
    db 879 ; Dex number.
    db <So much power is packed within its trunk that if it were to unleash that power, the resulting blast could level mountains and change the landscape.> ; Dex entry.

    db 650.0 ; Weight in kg.
    db 3.0 ; Height in meters.

    db CUFANT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
