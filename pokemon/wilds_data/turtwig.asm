    ...
    db 387 ; Dex number.
    db <Photosynthesis occurs across its body under the sun. The shell on its back is actually hardened soil.> ; Dex entry.

    db 10.2 ; Weight in kg.
    db 0.4 ; Height in meters.

    db TURTWIG 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
