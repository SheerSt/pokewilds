    ...
    db 766 ; Dex number.
    db <Displaying amazing teamwork, they follow the orders of their boss as they all help out in the search for their favorite berries.> ; Dex entry.

    db 82.8 ; Weight in kg.
    db 2.0 ; Height in meters.

    db PASSIMIAN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
