    ...
    db 640 ; Dex number.
    db <Its head sprouts horns as sharp as blades. Using whirlwind-like movements, it confounds and swiftly cuts opponents.> ; Dex entry.

    db 200.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db VIRIZION 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
