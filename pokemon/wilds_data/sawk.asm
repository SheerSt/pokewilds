    ...
    db 539 ; Dex number.
    db <If you see a Sawk training in the mountains in its single-minded pursuit of strength, it's best to quietly pass by.> ; Dex entry.

    db 51.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db SAWK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
