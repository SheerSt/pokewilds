    ...
    db 869 ; Dex number.
    db <Cream pours endlessly from this Pok�mon's body. The cream stiffens when compressed by an impact. A harder impact results in harder cream.> ; Dex entry.

    db 0.5 ; Weight in kg.
    db 0.3 ; Height in meters.

    db MILCERY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
