    ...
    db 263 ; Dex number.
    db <It marks its territory by rubbing its bristly fur on trees. This variety of Zigzagoon is friendlier and calmer than the kind native to Galar.> ; Dex entry.

    db 17.5 ; Weight in kg.
    db 0.4 ; Height in meters.

    db ZIGZAGOON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db OASIS ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
