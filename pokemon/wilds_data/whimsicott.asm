    ...
    db 547 ; Dex number.
    db <It scatters cotton all over the place as a prank. If it gets wet, it'll become too heavy to move and have no choice but to answer for its mischief.> ; Dex entry.

    db 6.6 ; Weight in kg.
    db 0.7 ; Height in meters.

    db COTTONEE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
