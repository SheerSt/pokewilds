...
MagnetonEvosAttacks:
	...
	db EVOLVE_LOCATION, 232, MAGNEZONE
	db 0 ; no more evolutions
	db 0, TRI_ATTACK
	db 1, TRI_ATTACK
...
PorygonEvosAttacks:
	db EVOLVE_TRADEITEM, UPGRADE, PORYGON2
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, CONVERSION
	db 5, RECYCLE
...
Porygon2EvosAttacks:
	db EVOLVE_TRADEITEM, DUBIOUSDISC, PORYGONZ
	db 0 ; no more evolutions
	db 1, DEFENSE_CURL
	db 1, TACKLE
	db 1, CONVERSION
...
WurmpleEvosAttacks:
	db EVOLVE_SILCOON, 7, SILCOON
	db EVOLVE_CASCOON, 7, CASCOON
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, STRING_SHOT
	db 5, POISON_STING
...
NincadaEvosAttacks:
	db EVOLVE_NINJASK, 20, NINJASK
	db EVOLVE_SHEDINJA, , SHEDINJA
	db 0 ; no more evolutions
	db 1, SAND_ATTACK
	db 1, SCRATCH
	db 5, HARDEN
...
NosepassEvosAttacks:
	...
	db EVOLVE_LOCATION, 232, PROBOPASS
	db 0 ; no more evolutions
	db 1, TACKLE
	db 4, HARDEN
	db 7, BLOCK
...
ClamperlEvosAttacks:
	db EVOLVE_TRADEITEM, DEEPSEATOOTH, HUNTAIL
	db EVOLVE_TRADEITEM, DEEPSEASCALE, GOREBYSS
	db 0 ; no more evolutions
	db 1, CLAMP
	db 1, WATER_GUN
	db 1, WHIRLPOOL
...
BurmyEvosAttacks:
	db EVOLVE_LEVELFEMALE, 20, WORMADAM
	db EVOLVE_LEVELMALE, 20, MOTHIM
	db 0 ; no more evolutions
	db 1, PROTECT
	db 10, TACKLE
	db 15, BUG_BITE
...
HappinyEvosAttacks:
	db EVOLVE_DAYHOLDITEM, OVALSTONE, CHANSEY
	db 0 ; no more evolutions
	db 1, MINIMIZE
	db 1, POUND
	db 1, COPYCAT
...
MantykeEvosAttacks:
	db EVOLVE_HASINPARTY, REMORAID, MANTINE
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, WATER_GUN
	db 4, SUPERSONIC
...
Flabã‰bã‰EvosAttacks:
	...
	db 20, WISH
	db 22, MAGICAL_LEAF
	db 24, GRASSY_TERRAIN
	db 28, PETAL_BLIZZARD
	db 33, AROMATHERAPY
	db 37, MISTY_TERRAIN
	db 41, MOONBLAST
	db 45, PETAL_DANCE
...
PanchamEvosAttacks:
	db EVOLVE_LEVELDARKINPARTY, 32, PANGORO
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, LEER
	db 4, ARM_THRUST
...
SpritzeeEvosAttacks:
	db EVOLVE_TRADEITEM, SACHET, AROMATISSE
	db 0 ; no more evolutions
	db 1, FAIRY_WIND
	db 1, SWEET_SCENT
	db 3, SWEET_KISS
...
SwirlixEvosAttacks:
	db EVOLVE_TRADEITEM, WHIPPEDDREAM, SLURPUFF
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, SWEET_SCENT
	db 3, PLAY_NICE
...
TyruntEvosAttacks:
	db EVOLVE_LEVELDAY, 39, TYRANTRUM
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, TAIL_WHIP
	db 4, ROAR
...
AmauraEvosAttacks:
	db EVOLVE_LEVELNIGHT, 39, AURORUS
	db 0 ; no more evolutions
	db 1, POWDER_SNOW
	db 1, GROWL
	db 4, ENCORE
...
PumpkabooEvosAttacks:
	db EVOLVE_TRADE, , GOURGEIST
	db 0 ; no more evolutions
	db 1, TRICK_OR_TREAT
	db 1, ASTONISH
	db 4, SHADOW_SNEAK
	db 8, CONFUSE_RAY
	db 12, TRICK_OR_TREAT
	db 12, RAZOR_LEAF
	db 16, LEECH_SEED
	db 20, BULLET_SEED
	db 24, TRICK_OR_TREAT
	db 24, SCARY_FACE
	db 28, WORRY_SEED
	db 32, SEED_BOMB
	db 36, TRICK_OR_TREAT
	db 36, SHADOW_BALL
	db 40, TRICK
	db 44, PAIN_SPLIT
	db 0 ; no more level-up moves
...
YungoosEvosAttacks:
	db EVOLVE_LEVELDAY, 20, GUMSHOOS
	db 0 ; no more evolutions
	db 1, TACKLE
	db 3, LEER
	db 7, PURSUIT
...
CharjabugEvosAttacks:
	...
	db EVOLVE_LOCATION, 232, VIKAVOLT
	db 0 ; no more evolutions
	db 0, CHARGE
	db 1, CHARGE
	db 1, VICEGRIP
...
CrabrawlerEvosAttacks:
	db EVOLVE_LOCATION, 257, CRABOMINABLE
	db 0 ; no more evolutions
	db 1, BUBBLE
	db 5, ROCK_SMASH
	db 9, LEER
...
FomantisEvosAttacks:
	db EVOLVE_LEVELDAY, 34, LURANTIS
	db 0 ; no more evolutions
	db 1, LEAFAGE
	db 1, FURY_CUTTER
	db 5, GROWTH
...
SalanditEvosAttacks:
	db EVOLVE_LEVELFEMALE, 33, SALAZZLE
	db 0 ; no more evolutions
	db 1, SCRATCH
	db 1, POISON_GAS
	db 5, SMOG
...
ComfeyEvosAttacks:
	...
	db 24, GRASS_KNOT
	db 27, SWEET_KISS
	db 30, FLORAL_HEALING
	db 33, PETAL_BLIZZARD
	db 36, AROMATHERAPY
	db 39, PLAY_ROUGH
	db 42, SWEET_SCENT
	db 45, PETAL_DANCE
	db 48, GRASSY_TERRAIN
	db 0 ; no more level-up moves
...
GolisopodEvosAttacks:
	db 0 ; no more evolutions
	db 0, FIRST_IMPRESSION
	db 1, FIRST_IMPRESSION
	db 1, STRUGGLE_BUG
	db 1, SAND_ATTACK
	db 1, DEFENSE_CURL
	db 1, SPITE
...
Kommo-oEvosAttacks:
	db 0 ; no more evolutions
	db 0, CLANGING_SCALES
	db 1, CLANGING_SCALES
	db 1, BELLY_DRUM
	db 1, AUTOTOMIZE
	db 1, TACKLE
	db 1, LEER
	...
	db 52, OUTRAGE
	db 60, CLOSE_COMBAT
	db 68, CLANGOROUS_SOUL
	db 76, BOOMBURST
	db 0 ; no more level-up moves

Tapu kokoEvosAttacks:
	db 0 ; no more evolutions
	db 1, QUICK_ATTACK
	db 1, THUNDER_SHOCK
	db 5, WITHDRAW
	...
	db 45, DISCHARGE
	db 50, MEAN_LOOK
	db 55, NATURES_MADNESS
	db 60, WILD_CHARGE
	db 65, BRAVE_BIRD
	db 70, POWER_SWAP
	db 75, ELECTRIC_TERRAIN
	db 0 ; no more level-up moves

Tapu leleEvosAttacks:
	db 0 ; no more evolutions
	db 1, ASTONISH
	db 1, CONFUSION
	db 5, WITHDRAW
	...
	db 65, TICKLE
	db 70, SKILL_SWAP
	db 75, PSYCHIC_TERRAIN
	db 0 ; no more level-up moves

Tapu buluEvosAttacks:
	db 0 ; no more evolutions
	db 1, LEAFAGE
	db 1, ROCK_SMASH
	db 5, WITHDRAW
	...
	db 65, MEGAHORN
	db 70, SKULL_BASH
	db 75, GRASSY_TERRAIN
	db 0 ; no more level-up moves

Tapu finiEvosAttacks:
	db 0 ; no more evolutions
	db 1, DISARMING_VOICE
	db 1, WATER_GUN
	db 5, WITHDRAW
...
CosmoemEvosAttacks:
	db EVOLVE_LEVELDAY, 53, SOLGALEO
	db EVOLVE_LEVELNIGHT, 53, LUNALA
	db 0 ; no more evolutions
	db 0, COSMIC_POWER
	db 1, COSMIC_POWER
	db 1, TELEPORT
...
SolgaleoEvosAttacks:
	db 0 ; no more evolutions
	db 0, SUNSTEEL_STRIKE
	db 1, SUNSTEEL_STRIKE
	db 1, COSMIC_POWER
	db 1, TELEPORT
	db 1, METAL_CLAW
	db 1, NOBLE_ROAR
...
MelmetalEvosAttacks:
	...
	db 72, DYNAMIC_PUNCH
	db 80, SUPERPOWER
	db 88, DOUBLE_IRON_BASH
	db 96, HYPER_BEAM
	db 0 ; no more level-up moves

GrookeyEvosAttacks:
	db EVOLVE_LEVEL, 16, THWACKEY
	db 0 ; no more evolutions
	db 1, SCRATCH
	db 1, GROWL
	db 6, BRANCH_POKE
...
OrbeetleEvosAttacks:
	...
	db 40, AFTER_YOU
	db 44, CALM_MIND
	db 48, PSYCHIC_TERRAIN
	db 0 ; no more level-up moves

NickitEvosAttacks:
	db EVOLVE_LEVEL, 18, THIEVUL
	db 0 ; no more evolutions
	db 1, QUICK_ATTACK
	db 1, TAIL_WHIP
	db 4, BEAT_UP
...
BoltundEvosAttacks:
	...
	db 48, WILD_CHARGE
	db 55, PLAY_ROUGH
	db 62, ELECTRIC_TERRAIN
	db 0 ; no more level-up moves

RolycolyEvosAttacks:
	db EVOLVE_LEVEL, 18, CARKOL
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, SMOKESCREEN
	db 5, RAPID_SPIN
...
SilicobraEvosAttacks:
	db EVOLVE_LEVEL, 36, SANDACONDA
	db 0 ; no more evolutions
	db 1, WRAP
	db 1, SAND_ATTACK
	db 5, MINIMIZE
...
ArrokudaEvosAttacks:
	db EVOLVE_LEVEL, 26, BARRASKEWDA
	db 0 ; no more evolutions
	db 1, PECK
	db 1, AQUA_JET
	db 6, FURY_ATTACK
...
SinisteaEvosAttacks:
	db EVOLVE_ITEM, CRACKEDPOT, POLTEAGEIST
	db 0 ; no more evolutions
	db 1, ASTONISH
	db 1, WITHDRAW
	db 6, AROMATIC_MIST
...
MorgremEvosAttacks:
	...
	db 0 ; no more evolutions
	db 0, FALSE_SURRENDER
	db 1, FALSE_SURRENDER
	db 1, FAKE_OUT
	db 1, CONFIDE
	db 1, BITE
	db 1, FLATTER
