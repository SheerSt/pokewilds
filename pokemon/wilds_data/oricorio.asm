    ...
    db 741 ; Dex number.
    db <It beats its wings together to create fire. As it moves in the steps of its beautiful dance, it bathes opponents in intense flames.> ; Dex entry.

    db 3.4 ; Weight in kg.
    db 0.6 ; Height in meters.

    db ORICORIO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
