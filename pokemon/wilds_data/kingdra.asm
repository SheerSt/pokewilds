    ...
    db 230 ; Dex number.
    db <With the arrival of a storm at sea, this Pok�mon will show itself on the surface. When a Kingdra and a Dragonite meet, a fierce battle ensues.> ; Dex entry.

    db 152.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db HORSEA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
