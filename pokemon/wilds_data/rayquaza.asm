    ...
    db 384 ; Dex number.
    db <Rayquaza is said to have lived for hundreds of millions of years. Legends remain of how it put to rest the clash between Kyogre and Groudon.> ; Dex entry.

    db 206.5 ; Weight in kg.
    db 7.0 ; Height in meters.

    db RAYQUAZA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
