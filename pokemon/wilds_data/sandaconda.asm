    ...
    db 844 ; Dex number.
    db <Its sand pouch has grown to tremendous proportions. More than 1,000,000 tons of sand now swirl around its body.> ; Dex entry.

    db 65.5 ; Weight in kg.
    db 3.8 ; Height in meters.

    db SILICOBRA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
