    db FLORGES ; Display name (DEFAULT for default name).

    db 671 ; Dex number.
    db <It claims exquisite flower gardens as its territory, and it obtains power from basking in the energy emitted by flowering plants.> ; Dex entry.

    db 10.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db FLABEBE_ORANGE 100 ; Base form(s) (MON_NAME for base species, then chance).
