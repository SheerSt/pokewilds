    ...
    db 402 ; Dex number.
    db <It crosses its knifelike arms in front of its chest when it cries. It can compose melodies ad lib.> ; Dex entry.

    db 25.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db KRICKETOT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
