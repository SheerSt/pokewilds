    ...
    db 821 ; Dex number.
    db <It will bravely challenge any opponent, no matter how powerful. This Pok�mon benefits from every battle�even a defeat increases its strength a bit.> ; Dex entry.
