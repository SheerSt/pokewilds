    ...
    db 642 ; Dex number.
    db <The spikes on its tail discharge immense bolts of lightning. It flies around the Unova region firing off lightning bolts.> ; Dex entry.

    db 61.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db THUNDURUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
