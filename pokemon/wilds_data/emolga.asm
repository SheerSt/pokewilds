    ...
    db 587 ; Dex number.
    db <As Emolga flutters through the air, it crackles with electricity. This Pokémon is cute, but it can cause a lot of trouble.> ; Dex entry.

    db 5.0 ; Weight in kg.
    db 0.4 ; Height in meters.

    db EMOLGA 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
