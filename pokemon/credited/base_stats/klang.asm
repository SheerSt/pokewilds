  ...
  ;  hp  atk  def  spd sat sdf
	...
	; tm/hm learnset
	tmhm SIGNAL_BEAM, THUNDERBOLT, WILD_CHARGE, VOLT_SWITCH, SHOCK_WAVE, CHARGE_BEAM, MAGNET_RISE, THUNDER_WAVE, ROCK_SMASH, HYPER_BEAM, UPROAR, FACADE, HIDDEN_POWER, ROUND, SNORE, BIND, FRUSTRATION, RETURN, CONFIDE, DOUBLE_TEAM, PROTECT, RECYCLE, SLEEP_TALK, SUBSTITUTE, SWAGGER, TOXIC, ALLY_SWITCH, GRAVITY, MAGIC_COAT, REST, TELEKINESIS, ROCK_POLISH, SANDSTORM, FLASH_CANNON, IRON_DEFENSE, ENDURE, STEEL_BEAM, STEEL_ROLLER, SCREECH, ASSURANCE, RISING_VOLTAGE, POWER_GEM
	; end