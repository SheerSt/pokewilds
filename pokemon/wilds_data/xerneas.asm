    ...
    db 716 ; Dex number.
    db <Legends say it can share eternal life. It slept for a thousand years in the form of a tree before its revival.> ; Dex entry.

    db 215.0 ; Weight in kg.
    db 3.0 ; Height in meters.

    db XERNEAS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
