    ...
    db 715 ; Dex number.
    db <Aggressive and cruel, this Pokémon will ruthlessly torment enemies that are helpless in the dark.> ; Dex entry.

    db 85.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db NOIBAT, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
