    ...
    db 610 ; Dex number.
    db <These Pok�mon nest in the ground and use their tusks to crush hard berries. Crushing berries is also how they test each other's strength.> ; Dex entry.

    db 18.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db AXEW 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
