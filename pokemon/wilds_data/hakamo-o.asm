    ...
    db 783 ; Dex number.
    db <The scaleless, scarred parts of its body are signs of its strength. It shows them off to defeated opponents.> ; Dex entry.

    db 47.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db JANGMO_O 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
