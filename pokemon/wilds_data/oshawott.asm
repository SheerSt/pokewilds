    ...
    db 501 ; Dex number.
    db <The scalchop on its stomach isn't just used for battle�it can be used to break open hard berries as well.> ; Dex entry.

    db 5.9 ; Weight in kg.
    db 0.5 ; Height in meters.

    db OSHAWOTT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
