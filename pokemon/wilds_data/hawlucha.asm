    ...
    db 701 ; Dex number.
    db <It drives its opponents to exhaustion with its agile maneuvers, then ends the fight with a flashy finishing move.> ; Dex entry.

    db 21.5 ; Weight in kg.
    db 0.8 ; Height in meters.

    db HAWLUCHA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
