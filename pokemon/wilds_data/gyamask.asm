    db YAMASK ; Display name (DEFAULT for default name).

    db 562 ; Dex number.
    db <A clay slab with cursed engravings took possession of a Yamask. The slab is said to be absorbing the Yamask's dark power.> ; Dex entry.

    db 0 ; Weight in kg.
    db 0 ; Height in meters.

    db YAMASK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
