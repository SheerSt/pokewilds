    ...
    db 740 ; Dex number.
    db <It aimed for the top but got lost and ended up on a snowy mountain. Being forced to endure the cold, this Pok�mon evolved and grew fur.> ; Dex entry.

    db 180.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db CRABRAWLER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
