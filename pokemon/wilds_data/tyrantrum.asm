    ...
    db 697 ; Dex number.
    db <Thanks to its gargantuan jaws, which could shred thick metal plates as if they were paper, it was invincible in the ancient world it once inhabited.> ; Dex entry.

    db 270.0 ; Weight in kg.
    db 2.5 ; Height in meters.

    db TYRUNT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
