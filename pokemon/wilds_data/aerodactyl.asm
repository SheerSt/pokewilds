    ...
    db 142 ; Dex number.
    db <A Pok�mon from the age of the dinosaurs. It used its sawlike fangs to shred its prey before eating them.> ; Dex entry.

    db 59.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db AERODACTYL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
