    ...
    db 96 ; Dex number.
    db <A Pok�mon that nourishes itself by eating dreams, it is thought to share common ancestry with Munna and Musharna.> ; Dex entry.

    db 32.4 ; Weight in kg.
    db 1.0 ; Height in meters.

    db DROWZEE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
