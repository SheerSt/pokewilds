    ...
    db 693 ; Dex number.
    db <After using the feelers on its oversized claw to detect the location of prey, Clawitzer launches a cannonball of water at its target.> ; Dex entry.

    db 35.3 ; Weight in kg.
    db 1.3 ; Height in meters.

    db CLAUNCHER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
