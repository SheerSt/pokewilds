    ...
    db 871 ; Dex number.
    db <It feeds on seaweed, using its teeth to scrape it off rocks. Electric current flows from the tips of its spines.> ; Dex entry.

    db 1.0 ; Weight in kg.
    db 0.3 ; Height in meters.

    db PINCURCHIN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
