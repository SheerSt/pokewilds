    ...
    db 270 ; Dex number.
    db <It searches about for clean water. If it does not drink water for too long, the leaf on its head wilts.> ; Dex entry.
    ...
    db WOODED_LAKE_WATER OASIS ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
