    ...
    db 145 ; Dex number.
    db <Zapdos is a legendary bird Pok�mon that has the ability to control electricity. It usually lives in thunderclouds. The Pok�mon gains power if it is stricken by lightning bolts.> ; Dex entry.

    db 52.6 ; Weight in kg.
    db 1.6 ; Height in meters.

    db ZAPDOS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
