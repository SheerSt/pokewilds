    ...
    db 43 ; Dex number.
    db <If exposed to moonlight, it starts to move. It roams far and wide at night to scatter its seeds.> ; Dex entry.

    db 5.4 ; Weight in kg.
    db 0.5 ; Height in meters.

    db ODDISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
