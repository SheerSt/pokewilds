    ...
    db 494 ; Dex number.
    db <This Pok�mon brings victory. It is said that Trainers with Victini always win, regardless of the type of encounter.> ; Dex entry.

    db 4.0 ; Weight in kg.
    db 0.4 ; Height in meters.

    db VICTINI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
