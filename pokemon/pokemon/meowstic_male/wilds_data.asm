    db MEOWSTIC ; Display name (DEFAULT for default name).

    db 678 ; Dex number.
    db <Females are a bit more selfish and aggressive than males. If they don't get what they want, they will torment you with their psychic abilities.> ; Dex entry.

    db 8.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db ESPURR 100 ; Base form(s) (MON_NAME for base species, then chance).
