    ...
    db 687 ; Dex number.
    db <Gazing at its luminescent spots will quickly induce a hypnotic state, putting the observer under Malamar's control.> ; Dex entry.

    db 47.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db INKAY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
