    ...
    db 177 ; Dex number.
    db <It is extremely good at climbing tree trunks and likes to eat the new sprouts on the trees.> ; Dex entry.

    db 2.0 ; Weight in kg.
    db 0.2 ; Height in meters.

    db NATU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db SAVANNA WOODED_LAKE RUINS_OUTER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
