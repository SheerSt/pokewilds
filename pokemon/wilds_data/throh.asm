    ...
    db 538 ; Dex number.
    db <It performs throwing moves with first-rate skill. Over the course of many battles, Throh's belt grows darker as it absorbs its wearer's sweat.> ; Dex entry.

    db 55.5 ; Weight in kg.
    db 1.3 ; Height in meters.

    db THROH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
