    ...
    db 757 ; Dex number.
    db <Its venom sacs produce a fluid that this Pok�mon then heats up with the flame in its tail. This process creates Salandit's poisonous gas.> ; Dex entry.

    db 4.8 ; Weight in kg.
    db 0.6 ; Height in meters.

    db SALANDIT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
