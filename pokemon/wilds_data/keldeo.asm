    ...
    db 647 ; Dex number.
    db <It crosses the world, running over the surfaces of oceans and rivers. It appears at scenic waterfronts.> ; Dex entry.

    db 48.5 ; Weight in kg.
    db 1.4 ; Height in meters.

    db KELDEO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
