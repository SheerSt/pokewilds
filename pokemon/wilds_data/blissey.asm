    ...
    db 242 ; Dex number.
    db <Whenever a Blissey finds a weakened Pok�mon, it will share its egg and offer its care until the other Pok�mon is all better.> ; Dex entry.

    db 46.8 ; Weight in kg.
    db 1.5 ; Height in meters.

    db HAPPINY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
