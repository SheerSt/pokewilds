    ...
    db 87 ; Dex number.
    db <Dewgong loves to snooze on bitterly cold ice. The sight of this Pok�mon sleeping on a glacier was mistakenly thought to be a mermaid by a mariner long ago.> ; Dex entry.
