    ...
    db 633 ; Dex number.
    db <When it encounters something, its first urge is usually to bite it. If it likes what it tastes, it will commit the associated scent to memory.> ; Dex entry.

    db 17.3 ; Weight in kg.
    db 0.8 ; Height in meters.

    db DEINO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
