    ...
    db 357 ; Dex number.
    db <The bunches of fruit around Tropius's neck are very popular with children. This Pok�mon loves fruit, and eats it continuously. Apparently, its love for fruit resulted in its own outgrowth of fruit.> ; Dex entry.

    db 100.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db TROPIUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
