    ...
    db 130 ; Dex number.
    db <It has an extremely aggressive nature. The Hyper Beam it shoots from its mouth totally incinerates all targets.> ; Dex entry.

    db 235.0 ; Weight in kg.
    db 6.5 ; Height in meters.
