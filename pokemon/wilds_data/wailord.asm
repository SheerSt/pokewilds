    ...
    db 321 ; Dex number.
    db <It can sometimes knock out opponents with the shock created by breaching and crashing its big body onto the water.> ; Dex entry.

    db 398.0 ; Weight in kg.
    db 14.5 ; Height in meters.

    db WAILMER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
