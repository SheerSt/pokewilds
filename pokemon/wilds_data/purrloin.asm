    ...
    db 509 ; Dex number.
    db <It steals things from people just to amuse itself with their frustration. A rivalry exists between this Pokémon and Nickit.> ; Dex entry.

    db 10.1 ; Weight in kg.
    db 0.4 ; Height in meters.

    db PURRLOIN, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
