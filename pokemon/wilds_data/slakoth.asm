    ...
    db 287 ; Dex number.
    db <Slakoth lolls around for over 20 hours every day. Because it moves so little, it does not need much food. This Pok�mon's sole daily meal consists of just three leaves.> ; Dex entry.
