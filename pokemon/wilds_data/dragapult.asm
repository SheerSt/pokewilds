    ...
    db 887 ; Dex number.
    db <When it isn't battling, it keeps Dreepy in the holes on its horns. Once a fight starts, it launches the Dreepy like supersonic missiles.> ; Dex entry.

    db 50.0 ; Weight in kg.
    db 3.0 ; Height in meters.

    db DREEPY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
