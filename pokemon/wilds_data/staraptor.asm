    ...
    db 398 ; Dex number.
    db <The muscles in its wings and legs are strong. It can easily fly while gripping a small Pokémon.> ; Dex entry.

    db 24.9 ; Weight in kg.
    db 1.2 ; Height in meters.

    db STARLY 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
