    ...
    db 569 ; Dex number.
    db <Due to Gigantamax energy, this Pok�mon's toxic gas has become much thicker, congealing into masses shaped like discarded toys.> ; Dex entry.

    db 107.3 ; Weight in kg.
    db 1.9 ; Height in meters.

    db TRUBBISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
