    ...
    db 428 ; Dex number.
    db <Lopunny is constantly monitoring its surroundings. If danger approaches, this Pok�mon responds with superdestructive kicks.> ; Dex entry.

    db 33.3 ; Weight in kg.
    db 1.2 ; Height in meters.

    db BUNEARY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
