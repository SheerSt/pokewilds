    ...
    db 400 ; Dex number.
    db <It busily makes its nest with stacks of branches and roots it has cut up with its sharp incisors.> ; Dex entry.

    db 31.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db BIDOOF 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
