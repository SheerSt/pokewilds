    ...
    db 584 ; Dex number.
    db <When its anger reaches a breaking point, this Pok�mon unleashes a fierce blizzard that freezes every creature around it, be they friend or foe.> ; Dex entry.

    db 57.5 ; Weight in kg.
    db 1.3 ; Height in meters.

    db VANILLITE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
