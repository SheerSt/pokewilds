    ...
    db 148 ; Dex number.
    db <It has long been thought that its crystalline orbs are imbued with the power to control the weather.> ; Dex entry.

    db 16.5 ; Weight in kg.
    db 4.0 ; Height in meters.

    db DRATINI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
