    ...
    db 38 ; Dex number.
    db <A deity resides in the snowy mountains where this Pok�mon lives. In ancient times, it was worshiped as that deity's incarnation.> ; Dex entry.

    db 19.9 ; Weight in kg.
    db 1.1 ; Height in meters.

    db VULPIX 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
