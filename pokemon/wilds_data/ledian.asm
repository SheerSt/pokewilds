    ...
    db 166 ; Dex number.
    db <While it's believed that starlight provides it with energy, this Pok�mon also loves to eat berries. In the daytime, it curls up in the grass to sleep.> ; Dex entry.

    db 35.6 ; Weight in kg.
    db 1.4 ; Height in meters.

    db LEDYBA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
