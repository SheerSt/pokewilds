    ...
    db 517 ; Dex number.
    db <Late at night, it appears beside people's pillows. As it feeds on dreams, the patterns on its body give off a faint glow.> ; Dex entry.

    db 23.3 ; Weight in kg.
    db 0.6 ; Height in meters.

    db MUNNA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
