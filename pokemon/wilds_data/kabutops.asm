    ...
    db 141 ; Dex number.
    db <Kabutops swam underwater to hunt for its prey in ancient times. The Pok�mon was apparently evolving from being a water dweller to living on land as evident from the beginnings of change in its gills and legs.> ; Dex entry.

    db 40.5 ; Weight in kg.
    db 1.3 ; Height in meters.

    db KABUTO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
