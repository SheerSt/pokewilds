    ...
    db 354 ; Dex number.
    db <Banette generates energy for laying strong curses by sticking pins into its own body. This Pok�mon was originally a pitiful plush doll that was thrown away.> ; Dex entry.
