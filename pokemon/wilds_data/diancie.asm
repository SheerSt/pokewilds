    ...
    db 719 ; Dex number.
    db <A sudden transformation of Carbink, its pink, glimmering body is said to be the loveliest sight in the whole world.> ; Dex entry.

    db 8.8 ; Weight in kg.
    db 0.7 ; Height in meters.

    db DIANCIE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
