    db MR.RIME ; Display name (DEFAULT for default name).

    db 866 ; Dex number.
    db <It's highly skilled at tap-dancing. It waves its cane of ice in time with its graceful movements.> ; Dex entry.

    db 58.2 ; Weight in kg.
    db 1.5 ; Height in meters.

    db MR_MIME 100 ; Base form(s) (MON_NAME for base species, then chance).
