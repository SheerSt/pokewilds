    db FLOETTE ; Display name (DEFAULT for default name).

    db 670 ; Dex number.
    db <It flutters around fields of flowers and cares for flowers that are starting to wilt. It draws out the hidden power of flowers to battle.> ; Dex entry.
