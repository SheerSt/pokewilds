    ...
    db 255 ; Dex number.
    db <Torchic sticks with its Trainer, following behind with unsteady steps. This Pok�mon breathes fire of over 1,800 degrees Fahrenheit, including fireballs that leave the foe scorched black.> ; Dex entry.
