    ...
    db 260 ; Dex number.
    db <Swampert is very strong. It has enough power to easily drag a boulder weighing more than a ton. This Pok�mon also has powerful vision that lets it see even in murky water.> ; Dex entry.

    db 81.9 ; Weight in kg.
    db 1.5 ; Height in meters.

    db MUDKIP 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
