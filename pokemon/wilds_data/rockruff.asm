    ...
    db 744 ; Dex number.
    db <This Pok�mon can bond very strongly with its Trainer, but it also has a habit of biting. Raising a Rockruff for a long time can be challenging.> ; Dex entry.

    db 9.2 ; Weight in kg.
    db 0.5 ; Height in meters.

    db ROCKRUFF 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
