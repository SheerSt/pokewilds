    ...
    db 712 ; Dex number.
    db <They chill the air around them to -150 degrees Fahrenheit, freezing the water in the air into ice that they use as armor.> ; Dex entry.

    db 99.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db BERGMITE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
