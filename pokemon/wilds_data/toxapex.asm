    ...
    db 748 ; Dex number.
    db <To survive in the cold waters of Galar, this Pok�mon forms a dome with its legs, enclosing its body so it can capture its own body heat.> ; Dex entry.

    db 14.5 ; Weight in kg.
    db 0.7 ; Height in meters.

    db MAREANIE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
