    ...
    db 359 ; Dex number.
    db <Long ago, superstitions were spread about it, saying it brought disaster. This fed a hatred of it, and it was driven deep into the mountains.> ; Dex entry.

    db 47.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db ABSOL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
