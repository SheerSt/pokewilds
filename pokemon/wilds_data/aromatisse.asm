    ...
    db 683 ; Dex number.
    db <The scent that constantly emits from its fur is so powerful that this Pok�mon's companions will eventually lose their sense of smell.> ; Dex entry.

    db 15.5 ; Weight in kg.
    db 0.8 ; Height in meters.

    db SPRITZEE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
