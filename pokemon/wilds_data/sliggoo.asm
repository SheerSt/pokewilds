    ...
    db 705 ; Dex number.
    db <Although this Pok�mon isn't very strong, its body is coated in a caustic slime that can melt through anything, so predators steer clear of it.> ; Dex entry.

    db 17.5 ; Weight in kg.
    db 0.8 ; Height in meters.

    db GOOMY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
