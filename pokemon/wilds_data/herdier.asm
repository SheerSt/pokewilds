    ...
    db 507 ; Dex number.
    db <Herdier is a very smart and friendly Pok�mon. So much so that there's a theory that Herdier was the first Pok�mon to partner with people.> ; Dex entry.

    db 14.7 ; Weight in kg.
    db 0.9 ; Height in meters.

    db LILLIPUP 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
