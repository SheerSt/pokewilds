    ...
    db 648 ; Dex number.
    db <The melodies sung by Meloetta have the power to make Pok�mon that hear them happy or sad.> ; Dex entry.

    db 6.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db MELOETTA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
