    ...
    db 36 ; Dex number.
    db <A timid fairy Pok�mon that is rarely seen, it will run and hide the moment it senses people.> ; Dex entry.

    db 40.0 ; Weight in kg.
    db 1.3 ; Height in meters.

    db CLEFFA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
