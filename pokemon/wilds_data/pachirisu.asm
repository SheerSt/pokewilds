    ...
    db 417 ; Dex number.
    db <It makes fur balls that crackle with static electricity. It stores them with berries in tree holes.> ; Dex entry.

    db 3.9 ; Weight in kg.
    db 0.4 ; Height in meters.

    db PACHIRISU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
