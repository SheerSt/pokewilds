    ...
    db 381 ; Dex number.
    db <Latios has the ability to make others see an image of what it has seen or imagines in its head. This Pokémon is intelligent and understands human speech.> ; Dex entry.

    db 60.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db LATIOS, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
