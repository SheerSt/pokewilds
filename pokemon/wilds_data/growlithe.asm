    ...
    db 58 ; Dex number.
    db <It has a brave and trustworthy nature. It fearlessly stands up to bigger and stronger foes.> ; Dex entry.

    db 19.0 ; Weight in kg.
    db 0.7 ; Height in meters.

    db GROWLITHE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db DEEP_FOREST PKMNMANSION ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
