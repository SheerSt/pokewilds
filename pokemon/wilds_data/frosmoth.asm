    ...
    db 873 ; Dex number.
    db <Icy scales fall from its wings like snow as it flies over fields and mountains. The temperature of its wings is less than -290 degrees Fahrenheit.> ; Dex entry.

    db 42.0 ; Weight in kg.
    db 1.3 ; Height in meters.

    db SNOM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
