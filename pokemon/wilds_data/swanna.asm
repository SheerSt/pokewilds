    ...
    db 581 ; Dex number.
    db <Despite their elegant appearance, they can flap their wings strongly and fly for thousands of miles.> ; Dex entry.

    db 24.2 ; Weight in kg.
    db 1.3 ; Height in meters.

    db DUCKLETT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
