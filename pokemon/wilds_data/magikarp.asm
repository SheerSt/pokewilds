    ...
    db 129 ; Dex number.
    db <It is virtually worthless in terms of both power and speed. It is the most weak and pathetic Pok�mon in the world.> ; Dex entry.

    db 10.0 ; Weight in kg.
    db 0.9 ; Height in meters.

    db MAGIKARP 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db MOUNTAIN_WATER TIDAL_BEACH_WATER WOODED_LAKE_WATER WOODED_LAKE_FISHING OCEAN_FISHING RIVER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
