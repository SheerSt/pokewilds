    ...
    db 881 ; Dex number.
    db <The shaking of its freezing upper half is what generates its electricity. It has a hard time walking around.> ; Dex entry.

    db 150.0 ; Weight in kg.
    db 2.3 ; Height in meters.

    db ARCTOZOLT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
