    ...
    db 418 ; Dex number.
    db <It swims by rotating its two tails like a screw. When it dives, its flotation sac collapses.> ; Dex entry.

    db 29.5 ; Weight in kg.
    db 0.7 ; Height in meters.

    db BUIZEL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db WOODED_LAKE_WATER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
