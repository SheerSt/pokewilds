    ...
    db 460 ; Dex number.
    db <If it sees any packs of Darumaka going after Snover, it chases them off, swinging its sizable arms like hammers.> ; Dex entry.

    db 135.5 ; Weight in kg.
    db 2.2 ; Height in meters.

    db SNOVER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
