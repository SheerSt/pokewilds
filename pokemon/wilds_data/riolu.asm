    ...
    db 447 ; Dex number.
    db <It's exceedingly energetic, with enough stamina to keep running all through the night. Taking it for walks can be a challenging experience.> ; Dex entry.

    db 20.2 ; Weight in kg.
    db 0.7 ; Height in meters.

    db RIOLU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
    ...
    db 1 ; Smash (always able on ROCK).
