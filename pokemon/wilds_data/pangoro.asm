    ...
    db 675 ; Dex number.
    db <This Pokémon is quick to anger, and it has no problem using its prodigious strength to get its way. It lives for duels against Obstagoon.> ; Dex entry.

    db 136.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db PANCHAM 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
