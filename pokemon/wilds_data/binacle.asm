    ...
    db 688 ; Dex number.
    db <After two Binacle find a suitably sized rock, they adhere themselves to it and live together. They cooperate to gather food during high tide.> ; Dex entry.

    db 31.0 ; Weight in kg.
    db 0.5 ; Height in meters.

    db BINACLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
