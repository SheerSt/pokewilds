    ...
    db 675 ; Dex number.
    db <This Pok�mon is quick to anger, and it has no problem using its prodigious strength to get its way. It lives for duels against Obstagoon.> ; Dex entry.

    db 136.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db PANCHAM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
