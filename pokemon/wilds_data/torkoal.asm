    ...
    db 324 ; Dex number.
    db <It burns coal inside its shell for energy. It blows out black soot if it is endangered.> ; Dex entry.

    db 80.4 ; Weight in kg.
    db 0.5 ; Height in meters.

    db TORKOAL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
