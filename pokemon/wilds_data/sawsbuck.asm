    ...
    db 586 ; Dex number.
    db <They migrate according to the seasons. People can tell the season by looking at Sawsbuck's horns.> ; Dex entry.

    db 92.5 ; Weight in kg.
    db 1.9 ; Height in meters.

    db DEERLING 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
