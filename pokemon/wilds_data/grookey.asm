    ...
    db 810 ; Dex number.
    db <When it uses its special stick to strike up a beat, the sound waves produced carry revitalizing energy to the plants and flowers in the area.> ; Dex entry.

    db 5.0 ; Weight in kg.
    db 0.3 ; Height in meters.

    db GROOKEY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
