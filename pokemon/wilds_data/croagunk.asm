    ...
    db 453 ; Dex number.
    db <It makes frightening noises with its poison-filled cheek sacs. When opponents flinch, Croagunk hits them with a poison jab.> ; Dex entry.

    db 23.0 ; Weight in kg.
