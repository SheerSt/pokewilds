    ...
    db 432 ; Dex number.
    db <It would claim another Pok�mon's nest as its own if it finds a nest sufficiently comfortable.> ; Dex entry.

    db 43.8 ; Weight in kg.
    db 1.0 ; Height in meters.

    db GLAMEOW 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
