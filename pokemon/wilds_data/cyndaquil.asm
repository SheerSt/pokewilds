    ...
    db 155 ; Dex number.
    db <Cyndaquil protects itself by flaring up the flames on its back. The flames are vigorous if the Pok�mon is angry. However, if it is tired, the flames splutter fitfully with incomplete combustion.> ; Dex entry.
