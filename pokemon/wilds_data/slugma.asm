    ...
    db 218 ; Dex number.
    db <Molten magma courses throughout Slugma's circulatory system. If this Pok�mon is chilled, the magma cools and hardens. Its body turns brittle and chunks fall off, reducing its size.> ; Dex entry.

    db 35.0 ; Weight in kg.
    db 0.7 ; Height in meters.

    db SLUGMA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db VOLCANO ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
