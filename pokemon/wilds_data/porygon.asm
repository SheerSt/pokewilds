    ...
    db 137 ; Dex number.
    db <State-of-the-art technology was used to create Porygon. It was the first artificial Pok�mon to be created via computer programming.> ; Dex entry.

    db 36.5 ; Weight in kg.
    db 0.8 ; Height in meters.

    db PORYGON 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
    ...
    db 1 ; Power (always able on ELECTRIC).zx
    db 0 ; Headbutt.
