    ...
    db 306 ; Dex number.
    db <Aggron claims an entire mountain as its own territory. It mercilessly beats up anything that violates its environment. This Pok�mon vigilantly patrols its territory at all times.> ; Dex entry.

    db 360.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db ARON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
