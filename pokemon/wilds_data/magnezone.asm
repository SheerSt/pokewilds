    ...
    db 462 ; Dex number.
    db <Some say that Magnezone receives signals from space via the antenna on its head and that it's being controlled by some mysterious being.> ; Dex entry.

    db 180.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db MAGNEMITE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
