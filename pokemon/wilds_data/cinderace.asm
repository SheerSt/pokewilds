    ...
    db 815 ; Dex number.
    db <Infused with Cinderace's fighting spirit, the gigantic Pyro Ball never misses its targets and completely roasts opponents.> ; Dex entry.

    db 33.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db SCORBUNNY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
