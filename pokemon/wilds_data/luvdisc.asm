    ...
    db 370 ; Dex number.
    db <If a Luvdisc is left on its own, it becomes despondent, leaving itself open to attack. That is when Pelipper snatch them up.> ; Dex entry.

    db 8.7 ; Weight in kg.
    db 0.6 ; Height in meters.

    db LUVDISC 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
