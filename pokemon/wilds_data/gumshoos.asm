    ...
    db 735 ; Dex number.
    db <When it finds a trace of its prey, it patiently stakes out the location...but it's always snoozing by nightfall.> ; Dex entry.

    db 14.2 ; Weight in kg.
    db 0.7 ; Height in meters.

    db YUNGOOS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
