    db UNOWN ; Display name (DEFAULT for default name).

    db 201 ; Dex number.
    db <This Pok�mon is shaped like ancient writing. It is a mystery as to which came first, the ancient writings or the various Unown. Research into this topic is ongoing but nothing is known.> ; Dex entry.

    db 5.0 ; Weight in kg.
    db 0.5 ; Height in meters.

    db UNOWN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
