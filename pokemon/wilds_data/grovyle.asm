    ...
    db 253 ; Dex number.
    db <The leaves growing out of Grovyle's body are convenient for camouflaging it from enemies in the forest. This Pok�mon is a master at climbing trees in jungles.> ; Dex entry.
