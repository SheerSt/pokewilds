    ...
    db 366 ; Dex number.
    db <Clamperl's sturdy shell is not only good for protection�it is also used for clamping and catching prey. A fully grown Clamperl's shell will be scored with nicks and scratches all over.> ; Dex entry.

    db 52.5 ; Weight in kg.
