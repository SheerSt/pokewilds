    ...
    db 511 ; Dex number.
    db <It shares the leaf on its head with weary-looking Pok�mon. These leaves are known to relieve stress.> ; Dex entry.

    db 10.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db PANSAGE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
