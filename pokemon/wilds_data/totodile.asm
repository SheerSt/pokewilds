    ...
    db 158 ; Dex number.
    db <Despite the smallness of its body, Totodile's jaws are very powerful. While the Pok�mon may think it is just playfully nipping, its bite has enough power to cause serious injury.> ; Dex entry.
