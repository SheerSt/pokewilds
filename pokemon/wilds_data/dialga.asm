    ...
    db 483 ; Dex number.
    db <A Pok�mon spoken of in legend. It is said that time began moving when Dialga was born.> ; Dex entry.

    db 683.0 ; Weight in kg.
    db 5.4 ; Height in meters.

    db DIALGA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
