    ...
    db 893 ; Dex number.
    db <This Zarude left its pack to raise a human child. The cloth Zarude would wrap the child with has a comforting scent that calmed the child's crying.> ; Dex entry.

    db 70.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db ZARUDE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
