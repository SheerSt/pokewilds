    ...
    db 645 ; Dex number.
    db <Lands visited by Landorus grant such bountiful crops that it has been hailed as �The Guardian of the Fields.�> ; Dex entry.

    db 68.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db LANDORUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
