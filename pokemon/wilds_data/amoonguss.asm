    ...
    db 591 ; Dex number.
    db <This Pok�mon puffs poisonous spores at its foes. If the spores aren't washed off quickly, they'll grow into mushrooms wherever they land.> ; Dex entry.

    db 10.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db FOONGUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
