    ...
    db 189 ; Dex number.
    db <Jumpluff rides warm southern winds to cross the sea and fly to foreign lands. The Pok�mon descends to the ground when it encounters cold air while it is floating.> ; Dex entry.
