    ...
    db 65 ; Dex number.
    db <It has an incredibly high level of intelligence. Some say that Alakazam remembers everything that ever happens to it, from birth till death.> ; Dex entry.

    db 48.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db ABRA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
