    ...
    db 556 ; Dex number.
    db <With noises that could be mistaken for the rattles of maracas, it creates an upbeat rhythm, startling bird Pok�mon and making them fly off in a hurry.> ; Dex entry.

    db 28.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db MARACTUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
