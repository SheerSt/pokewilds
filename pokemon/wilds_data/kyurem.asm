    ...
    db 646 ; Dex number.
    db <Dwelling within it is a power even greater than that of Reshiram or Zekrom, but the extreme cold keeps that power bound.> ; Dex entry.

    db 325.0 ; Weight in kg.
    db 3.0 ; Height in meters.

    db KYUREM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
