    ...
    db 211 ; Dex number.
    db <When faced with a larger opponent, it swallows as much water as it can to match the opponent's size.> ; Dex entry.

    db 3.9 ; Weight in kg.
    db 0.5 ; Height in meters.

    db QWILFISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
