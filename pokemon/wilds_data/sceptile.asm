    ...
    db 254 ; Dex number.
    db <The leaves growing on Sceptile's body are very sharp edged. This Pok�mon is very agile�it leaps all over the branches of trees and jumps on its foe from above or behind.> ; Dex entry.

    db 52.2 ; Weight in kg.
    db 1.7 ; Height in meters.

    db TREECKO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
