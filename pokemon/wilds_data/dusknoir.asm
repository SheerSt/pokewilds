    ...
    db 477 ; Dex number.
    db <At the bidding of transmissions from the spirit world, it steals people and Pok�mon away. No one knows whether it has a will of its own.> ; Dex entry.

    db 106.6 ; Weight in kg.
