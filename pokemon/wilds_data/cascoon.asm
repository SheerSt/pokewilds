    ...
    db 268 ; Dex number.
    db <Cascoon makes its protective cocoon by wrapping its body entirely with a fine silk from its mouth. Once the silk goes around its body, it hardens. This Pok�mon prepares for its evolution inside the cocoon.> ; Dex entry.
