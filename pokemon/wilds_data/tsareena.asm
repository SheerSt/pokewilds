    ...
    db 763 ; Dex number.
    db <This feared Pok�mon has long, slender legs and a cruel heart. It shows no mercy as it stomps on its opponents.> ; Dex entry.

    db 21.4 ; Weight in kg.
    db 1.2 ; Height in meters.

    db BOUNSWEET 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
