    ...
    db 890 ; Dex number.
    db <As a result of Rose's meddling, Eternatus absorbed all the energy in the Galar region. It's now in a state of power overload.> ; Dex entry.

    db 950.0 ; Weight in kg.
    db 20.0 ; Height in meters.

    db ETERNATUS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
