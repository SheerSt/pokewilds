    ...
    db 545 ; Dex number.
    db <Scolipede latches on to its prey with the claws on its neck before slamming them into the ground and jabbing them with its claws' toxic spikes.> ; Dex entry.

    db 200.5 ; Weight in kg.
    db 2.5 ; Height in meters.

    db VENIPEDE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
