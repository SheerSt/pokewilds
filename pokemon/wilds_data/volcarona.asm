    ...
    db 637 ; Dex number.
    db <Volcarona scatters burning scales. Some say it does this to start fires. Others say it's trying to rescue those that suffer in the cold.> ; Dex entry.

    db 46.0 ; Weight in kg.
    db 1.6 ; Height in meters.

    db LARVESTA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
