    ...
    db 213 ; Dex number.
    db <It stores berries inside its shell. To avoid attacks, it hides beneath rocks and remains completely still.> ; Dex entry.

    db 20.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db SHUCKLE 100 ; Base form(s) (MON_NAME for base species, then chance).
