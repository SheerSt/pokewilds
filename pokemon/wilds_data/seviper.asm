    ...
    db 336 ; Dex number.
    db <Seviper shares a generations-long feud with Zangoose. The scars on its body are evidence of vicious battles. This Pok�mon attacks using its sword-edged tail.> ; Dex entry.

    db 52.5 ; Weight in kg.
    db 2.7 ; Height in meters.

    db SEVIPER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
