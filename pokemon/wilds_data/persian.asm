    ...
    db 53 ; Dex number.
    db <Getting this prideful Pok�mon to warm up to you takes a lot of effort, and it will claw at you the moment it gets annoyed.> ; Dex entry.

    db 32.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db MEOWTH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
