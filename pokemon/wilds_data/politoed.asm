    ...
    db 186 ; Dex number.
    db <At nightfall, these Pok�mon appear on the shores of lakes. They announce their territorial claims by letting out cries that sound like shouting.> ; Dex entry.

    db 33.9 ; Weight in kg.
