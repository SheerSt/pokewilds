    ...
    db 305 ; Dex number.
    db <Lairon tempers its steel body by drinking highly nutritious mineral springwater until it is bloated. This Pok�mon makes its nest close to springs of delicious water.> ; Dex entry.
