    ...
    db 600 ; Dex number.
    db <When Klang goes all out, the minigear links up perfectly with the outer part of the big gear, and this Pok�mon's rotation speed increases sharply.> ; Dex entry.

    db 51.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db KLINK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
