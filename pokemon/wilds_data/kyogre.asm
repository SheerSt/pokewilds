    ...
    db 382 ; Dex number.
    db <Through Primal Reversion and with nature's full power, it will take back its true form. It can summon storms that cause the sea levels to rise.> ; Dex entry.

    db 352.0 ; Weight in kg.
    db 4.5 ; Height in meters.

    db KYOGRE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
