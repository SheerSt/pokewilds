    ...
    db 31 ; Dex number.
    db <Nidoqueen's body is encased in extremely hard scales. It is adept at sending foes flying with harsh tackles. This Pok�mon is at its strongest when it is defending its young.> ; Dex entry.
