    ...
    db 559 ; Dex number.
    db <If it locks eyes with you, watch out! Nothing and no one is safe from the reckless headbutts of this troublesome Pokémon.> ; Dex entry.

    db 11.8 ; Weight in kg.
    db 0.6 ; Height in meters.

    db SCRAGGY, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
