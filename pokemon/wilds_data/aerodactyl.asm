    ...
    db 142 ; Dex number.
    db <A Pokémon from the age of the dinosaurs. It used its sawlike fangs to shred its prey before eating them.> ; Dex entry.

    db 59.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db AERODACTYL 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
