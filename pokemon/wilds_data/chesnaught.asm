    ...
    db 652 ; Dex number.
    db <Its Tackle is forceful enough to flip a 50-ton tank. It shields its allies from danger with its own body.> ; Dex entry.

    db 90.0 ; Weight in kg.
    db 1.6 ; Height in meters.

    db CHESPIN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
