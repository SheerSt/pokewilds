    ...
    db 223 ; Dex number.
    db <The water they shoot from their mouths can hit moving prey from more than 300 feet away.> ; Dex entry.

    db 12.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db REMORAID 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db OASIS_POND RIVER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
