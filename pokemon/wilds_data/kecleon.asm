    ...
    db 352 ; Dex number.
    db <Kecleon is capable of changing its body colors at will to blend in with its surroundings. There is one exception—this Pokémon can't change the zigzag pattern on its belly.> ; Dex entry.

    db 22.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db KECLEON, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
