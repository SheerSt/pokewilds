    ...
    db 193 ; Dex number.
    db <Yanma is capable of seeing 360 degrees without having to move its eyes. It is a great flier that is adept at making sudden stops and turning midair. This Pok�mon uses its flying ability to quickly chase down targeted prey.> ; Dex entry.

    db 38.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db YANMA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db SAVANNA SAVANNA WOODED_LAKE ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
