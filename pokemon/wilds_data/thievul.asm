    ...
    db 828 ; Dex number.
    db <It secretly marks potential targets with a scent. By following the scent, it stalks its targets and steals from them when they least expect it.> ; Dex entry.

    db 19.9 ; Weight in kg.
    db 1.2 ; Height in meters.

    db NICKIT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
