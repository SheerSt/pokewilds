    ...
    db 316 ; Dex number.
    db <Virtually all of Gulpin's body is its stomach. As a result, it can swallow something its own size. This Pok�mon's stomach contains a special fluid that digests anything.> ; Dex entry.

    db 10.3 ; Weight in kg.
