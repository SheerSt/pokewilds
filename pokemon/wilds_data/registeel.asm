    ...
    db 379 ; Dex number.
    db <Registeel has a body that is harder than any kind of metal. Its body is apparently hollow. No one has any idea what this Pok�mon eats.> ; Dex entry.

    db 205.0 ; Weight in kg.
    db 1.9 ; Height in meters.

    db REGISTEEL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
