    ...
    db 55 ; Dex number.
    db <This Pok�mon lives in gently flowing rivers. It paddles through the water with its long limbs, putting its graceful swimming skills on display.> ; Dex entry.

    db 76.6 ; Weight in kg.
    db 1.7 ; Height in meters.

    db PSYDUCK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
