    ...
    db 632 ; Dex number.
    db <They lay their eggs deep inside their nests. When attacked by Heatmor, they retaliate using their massive mandibles.> ; Dex entry.

    db 33.0 ; Weight in kg.
    db 0.3 ; Height in meters.

    db DURANT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
