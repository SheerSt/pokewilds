    ...
    db 877 ; Dex number.
    db <As it eats the seeds stored up in its pocket-like pouches, this Pok�mon is not just satisfying its constant hunger. It's also generating electricity.> ; Dex entry.

    db 3.0 ; Weight in kg.
    db 0.3 ; Height in meters.

    db MORPEKO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
