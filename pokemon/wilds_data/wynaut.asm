    ...
    db 360 ; Dex number.
    db <It tends to move in a pack. Individuals squash against one another to toughen their spirits.> ; Dex entry.

    db 14.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db WYNAUT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
