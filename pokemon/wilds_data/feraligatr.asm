    ...
    db 160 ; Dex number.
    db <Feraligatr intimidates its foes by opening its huge mouth. In battle, it will kick the ground hard with its thick and powerful hind legs to charge at the foe at an incredible speed.> ; Dex entry.

    db 88.8 ; Weight in kg.
    db 2.3 ; Height in meters.

    db TOTODILE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
