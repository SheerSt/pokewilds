    ...
    db 768 ; Dex number.
    db <It will do anything to win, taking advantage of every opening and finishing opponents off with the small claws on its front legs.> ; Dex entry.

    db 108.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db WIMPOD 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
