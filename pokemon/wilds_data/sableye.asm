    ...
    db 302 ; Dex number.
    db <This Pok�mon is feared. When its gemstone eyes begin to glow with a sinister shine, it's believed that Sableye will steal people's spirits away.> ; Dex entry.

    db 11.0 ; Weight in kg.
    db 0.5 ; Height in meters.

    db SABLEYE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
