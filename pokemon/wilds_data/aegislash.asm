    ...
    db 681 ; Dex number.
    db <In this defensive stance, Aegislash uses its steel body and a force field of spectral power to reduce the damage of any attack.> ; Dex entry.

    db 53.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db HONEDGE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
