    ...
    db 274 ; Dex number.
    db <It lives deep in forests. With the leaf on its head, it makes a flute whose song makes listeners uneasy.> ; Dex entry.

    db 28.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db SEEDOT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
