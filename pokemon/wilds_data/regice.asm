    ...
    db 378 ; Dex number.
    db <Regice's body was made during an ice age. The deep-frozen body can't be melted, even by fire. This Pok�mon controls frigid air of -328 degrees Fahrenheit.> ; Dex entry.

    db 175.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db REGICE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
