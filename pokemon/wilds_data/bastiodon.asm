    ...
    db 411 ; Dex number.
    db <While it can guard against any sort of attack from the front, it is left without recourse when attacked from behind.> ; Dex entry.

    db 149.5 ; Weight in kg.
    db 1.3 ; Height in meters.

    db SHIELDON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
