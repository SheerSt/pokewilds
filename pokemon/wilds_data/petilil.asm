    ...
    db 548 ; Dex number.
    db <Petilil appears around sources of clean water. Boiling leaves from this Pok�mon's head results in a liquid that's sometimes used as a bug repellent.> ; Dex entry.

    db 6.6 ; Weight in kg.
    db 0.5 ; Height in meters.

    db PETILIL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
