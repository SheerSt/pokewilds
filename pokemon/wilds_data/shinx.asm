    ...
    db 403 ; Dex number.
    db <This Pok�mon generates electricity by contracting its muscles. Excited trembling is a sign that Shinx is generating a tremendous amount of electricity.> ; Dex entry.

    db 9.5 ; Weight in kg.
    db 0.5 ; Height in meters.

    db SHINX 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
