    ...
    db 72 ; Dex number.
    db <Tentacool is not a particularly strong swimmer. It drifts across the surface of shallow seas as it searches for prey.> ; Dex entry.

    db 45.5 ; Weight in kg.
    db 0.9 ; Height in meters.

    db TENTACOOL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db TIDAL_BEACH_WATER OCEAN_FISHING ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
