    ...
    db 493 ; Dex number.
    db <According to the legends of Sinnoh, this Pokémon emerged from an egg and shaped all there is in this world.> ; Dex entry.

    db 320.0 ; Weight in kg.
    db 3.2 ; Height in meters.

    db ARCEUS 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
