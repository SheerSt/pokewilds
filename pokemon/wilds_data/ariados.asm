    ...
    db 168 ; Dex number.
    db <There are some areas where people use the string Ariados spins for their own weaving. The resulting cloth is popular for its strength.> ; Dex entry.

    db 33.5 ; Weight in kg.
    db 1.1 ; Height in meters.

    db SPINARAK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
