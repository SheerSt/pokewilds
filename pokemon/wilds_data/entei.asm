    ...
    db 244 ; Dex number.
    db <Entei embodies the passion of magma. This Pok�mon is thought to have been born in the eruption of a volcano. It sends up massive bursts of fire that utterly consume all that they touch.> ; Dex entry.

    db 198.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db ENTEI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
