    ...
    db 423 ; Dex number.
    db <It secretes a purple fluid to deter enemies. This fluid isn't poisonous�instead, it's super sticky, and once it sticks, it's very hard to unstick.> ; Dex entry.

    db 29.9 ; Weight in kg.
    db 0.9 ; Height in meters.

    db SHELLOS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
