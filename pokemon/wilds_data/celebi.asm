    ...
    db 251 ; Dex number.
    db <This Pok�mon has the ability to move through time. Records describing it as a forest deity can be found from many different eras.> ; Dex entry.

    db 5.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db CELEBI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
