    ...
    db 249 ; Dex number.
    db <Lugia's wings pack devastating power�a light fluttering of its wings can blow apart regular houses. As a result, this Pok�mon chooses to live out of sight deep under the sea.> ; Dex entry.

    db 216.0 ; Weight in kg.
    db 5.2 ; Height in meters.

    db LUGIA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
