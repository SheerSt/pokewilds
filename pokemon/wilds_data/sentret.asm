    ...
    db 161 ; Dex number.
    db <When Sentret sleeps, it does so while another stands guard. The sentry wakes the others at the first sign of danger. When this Pok�mon becomes separated from its pack, it becomes incapable of sleep due to fear.> ; Dex entry.

    db 6.0 ; Weight in kg.
    db 0.8 ; Height in meters.

    db SENTRET 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
