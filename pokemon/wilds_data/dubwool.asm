    ...
    db 832 ; Dex number.
    db <Weave a carpet from its springy wool, and you end up with something closer to a trampoline. You'll start to bounce the moment you set foot on it.> ; Dex entry.

    db 43.0 ; Weight in kg.
    db 1.3 ; Height in meters.

    db WOOLOO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
