    ...
    db 312 ; Dex number.
    db <Minun is more concerned about cheering on its partners than its own safety. It shorts out the electricity in its body to create brilliant showers of sparks to cheer on its teammates.> ; Dex entry.

    db 4.2 ; Weight in kg.
    db 0.4 ; Height in meters.

    db MINUN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
