    ...
    db 285 ; Dex number.
    db <Shroomish live in damp soil in the dark depths of forests. They are often found keeping still under fallen leaves. This Pok�mon feeds on compost that is made up of fallen, rotted leaves.> ; Dex entry.

    db 4.5 ; Weight in kg.
    db 0.4 ; Height in meters.

    db SHROOMISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
