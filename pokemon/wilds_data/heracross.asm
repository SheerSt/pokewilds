    ...
    db 214 ; Dex number.
    db <Heracross loves sweet sap and will go looking through forests for it. The Pok�mon uses its two antennae to pick up scents as it searches.> ; Dex entry.

    db 54.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db HERACROSS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
