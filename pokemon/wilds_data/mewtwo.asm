    ...
    db 150 ; Dex number.
    db <Mewtwo is a Pok�mon that was created by genetic manipulation. However, even though the scientific power of humans created this Pok�mon's body, they failed to endow Mewtwo with a compassionate heart.> ; Dex entry.

    db 122.0 ; Weight in kg.
    db 2.0 ; Height in meters.

    db MEWTWO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
