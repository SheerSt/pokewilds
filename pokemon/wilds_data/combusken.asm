    ...
    db 256 ; Dex number.
    db <Combusken toughens up its legs and thighs by running through fields and mountains. This Pok�mon's legs possess both speed and power, enabling it to dole out 10 kicks in one second.> ; Dex entry.
