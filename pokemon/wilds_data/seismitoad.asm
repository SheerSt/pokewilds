    ...
    db 537 ; Dex number.
    db <The vibrating of the bumps all over its body causes earthquake-like tremors. Seismitoad and Croagunk are similar species.> ; Dex entry.

    db 62.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db TYMPOLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
