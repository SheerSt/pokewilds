    ...
    db 217 ; Dex number.
    db <In the forests inhabited by Ursaring, it is said that there are many streams and towering trees where they gather food. This Pok�mon walks through its forest gathering food every day.> ; Dex entry.

    db 125.8 ; Weight in kg.
    db 1.8 ; Height in meters.

    db TEDDIURSA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
