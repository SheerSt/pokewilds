    ...
    db 800 ; Dex number.
    db <It survives by absorbing light. After a long time spent slumbering underground, impurities accumulated within it, causing its body to darken.> ; Dex entry.

    db 230.0 ; Weight in kg.
    db 2.4 ; Height in meters.

    db NECROZMA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
