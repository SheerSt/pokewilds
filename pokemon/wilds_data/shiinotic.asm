    ...
    db 756 ; Dex number.
    db <Its flickering spores lure in prey and put them to sleep. Once this Pok�mon has its prey snoozing, it drains their vitality with its fingertips.> ; Dex entry.

    db 11.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db MORELULL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
