    ...
    db 257 ; Dex number.
    db <In battle, Blaziken blows out intense flames from its wrists and attacks foes courageously. The stronger the foe, the more intensely this Pok�mon's wrists burn.> ; Dex entry.

    db 52.0 ; Weight in kg.
    db 1.9 ; Height in meters.

    db TORCHIC 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
