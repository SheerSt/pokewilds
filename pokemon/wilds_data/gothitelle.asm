    ...
    db 576 ; Dex number.
    db <It has tremendous psychic power, but it dislikes conflict. It's also able to predict the future based on the movement of the stars.> ; Dex entry.

    db 44.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db GOTHITA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
