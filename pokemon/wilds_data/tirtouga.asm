    ...
    db 564 ; Dex number.
    db <Based on studies of its skeletal structure, it can apparently dive to ocean depths of over half a mile.> ; Dex entry.

    db 16.5 ; Weight in kg.
    db 0.7 ; Height in meters.

    db TIRTOUGA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
