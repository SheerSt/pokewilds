    ...
    db 777 ; Dex number.
    db <With the long hairs on its back, this Pok�mon takes in electricity from other electric Pok�mon. It stores what it absorbs in an electric sac.> ; Dex entry.

    db 3.3 ; Weight in kg.
    db 0.3 ; Height in meters.

    db TOGEDEMARU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
