    ...
    db 228 ; Dex number.
    db <Houndour hunt as a coordinated pack. They communicate with each other using a variety of cries to corner their prey. This Pokémon's remarkable teamwork is unparalleled.> ; Dex entry.

    db 10.8 ; Weight in kg.
    db 0.6 ; Height in meters.

    db HOUNDOUR, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
