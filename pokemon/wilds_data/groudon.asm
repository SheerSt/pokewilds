    ...
    db 383 ; Dex number.
    db <Groudon is said to be the personification of the land itself. Legends tell of its many clashes against Kyogre, as each sought to gain the power of nature.> ; Dex entry.

    db 950.0 ; Weight in kg.
    db 3.5 ; Height in meters.

    db GROUDON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
