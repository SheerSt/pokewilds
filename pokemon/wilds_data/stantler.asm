    ...
    db 234 ; Dex number.
    db <Stantler's magnificent antlers were traded at high prices as works of art. As a result, this Pok�mon was hunted close to extinction by those who were after the priceless antlers.> ; Dex entry.

    db 71.2 ; Weight in kg.
    db 1.4 ; Height in meters.

    db STANTLER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
