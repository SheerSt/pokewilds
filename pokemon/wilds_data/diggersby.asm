    ...
    db 660 ; Dex number.
    db <With power equal to an excavator, it can dig through dense bedrock. It's a huge help during tunnel construction.> ; Dex entry.

    db 42.4 ; Weight in kg.
    db 1.0 ; Height in meters.

    db BUNNELBY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
