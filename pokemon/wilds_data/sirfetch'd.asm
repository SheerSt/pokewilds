    ...
    db 865 ; Dex number.
    db <Only Farfetch'd that have survived many battles can attain this evolution. When this Pok�mon's leek withers, it will retire from combat.> ; Dex entry.

    db 117.0 ; Weight in kg.
    db 0.8 ; Height in meters.

    db FARFETCHD 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
