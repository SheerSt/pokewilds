    ...
    db 594 ; Dex number.
    db <It uses its special mucus to close the wounds of injured Pokémon. The reason for this behavior remains unknown.> ; Dex entry.

    db 31.6 ; Weight in kg.
    db 1.2 ; Height in meters.

    db ALOMOMOLA 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
