    ...
    db 226 ; Dex number.
    db <If it builds up enough speed swimming, it can jump out above the waves and glide for over 300 feet.> ; Dex entry.

    db 220.0 ; Weight in kg.
    db 2.1 ; Height in meters.

    db MANTYKE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
    ...
    db 4 ; Water offset for OW sprites, in pixels.