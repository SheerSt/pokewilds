    ...
    db 269 ; Dex number.
    db <Dustox is instinctively drawn to light. Swarms of this Pok�mon are attracted by the bright lights of cities, where they wreak havoc by stripping the leaves off roadside trees for food.> ; Dex entry.

    db 31.6 ; Weight in kg.
