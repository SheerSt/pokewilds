    ...
    db 541 ; Dex number.
    db <Forests where Swadloon live have superb foliage because the nutrients they make from fallen leaves nourish the plant life.> ; Dex entry.

    db 7.3 ; Weight in kg.
    db 0.5 ; Height in meters.

    db SEWADDLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
