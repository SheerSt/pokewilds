    ...
    db 703 ; Dex number.
    db <Born from the high temperatures and pressures deep underground, it defends itself by firing beams from the jewel part of its body.> ; Dex entry.

    db 5.7 ; Weight in kg.
    db 0.3 ; Height in meters.

    db CARBINK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
