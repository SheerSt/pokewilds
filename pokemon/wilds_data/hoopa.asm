    ...
    db 720 ; Dex number.
    db <In its true form, it possess a huge amount of power. Legends of its avarice tell how it once carried off an entire castle to gain the treasure hidden within.> ; Dex entry.

    db 9.0 ; Weight in kg.
    db 0.5 ; Height in meters.

    db HOOPA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
