    ...
    db 488 ; Dex number.
    db <Shiny particles are released from its wings like a veil. It is said to represent the crescent moon.> ; Dex entry.

    db 85.6 ; Weight in kg.
    db 1.5 ; Height in meters.

    db CRESSELIA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
