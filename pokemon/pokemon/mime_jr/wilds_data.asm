    db MIME JR. ; Display name (DEFAULT for default name).

    db 439 ; Dex number.
    db <It mimics everyone it sees, but it puts extra effort into copying the graceful dance steps of Mr. Rime as practice.> ; Dex entry.

    db 13.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db MIME JR. 100 ; Base form(s) (MON_NAME for base species, then chance).
