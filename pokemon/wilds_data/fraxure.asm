    ...
    db 611 ; Dex number.
    db <After battle, this Pok�mon carefully sharpens its tusks on river rocks. It needs to take care of its tusks�if one breaks, it will never grow back.> ; Dex entry.
