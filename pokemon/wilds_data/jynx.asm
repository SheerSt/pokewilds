    ...
    db 124 ; Dex number.
    db <Jynx walks rhythmically, swaying and shaking its hips as if it were dancing. Its motions are so bouncingly alluring, people seeing it are compelled to shake their hips without giving any thought to what they are doing.> ; Dex entry.

    db 40.6 ; Weight in kg.
    db 1.4 ; Height in meters.

    db SMOOCHUM 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
