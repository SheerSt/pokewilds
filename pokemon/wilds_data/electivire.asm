    ...
    db 466 ; Dex number.
    db <It pushes the tips of its tails against its foes and then lets loose a high-voltage current. Its foes are burned to a crisp in an instant.> ; Dex entry.

    db 138.6 ; Weight in kg.
    db 1.8 ; Height in meters.

    db ELEKID 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
