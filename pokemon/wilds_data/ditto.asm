    ...
    db 132 ; Dex number.
    db <It can reconstitute its entire cellular structure to change into what it sees, but it returns to normal when it relaxes.> ; Dex entry.

    db 4.0 ; Weight in kg.
    db 0.3 ; Height in meters.

    db DITTO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
