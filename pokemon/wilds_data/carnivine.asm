    ...
    db 455 ; Dex number.
    db <It attracts prey with its sweet-smelling saliva, then chomps down. It takes a whole day to eat prey.> ; Dex entry.

    db 27.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db CARNIVINE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
