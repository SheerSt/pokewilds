    ...
    db 104 ; Dex number.
    db <When the memory of its departed mother brings it to tears, its cries echo mournfully within the skull it wears on its head.> ; Dex entry.
    ...
    db MOUNTAIN DESERT GRAVEYARD VOLCANO ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
