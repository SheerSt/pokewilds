    ...
    db 465 ; Dex number.
    db <Tangrowth has two arms that it can extend as it pleases. Recent research has shown that these arms are, in fact, bundles of vines.> ; Dex entry.

    db 128.6 ; Weight in kg.
