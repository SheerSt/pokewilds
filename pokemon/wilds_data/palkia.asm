    ...
    db 484 ; Dex number.
    db <It is said to live in a gap in the spatial dimension parallel to ours. It appears in mythology.> ; Dex entry.

    db 336.0 ; Weight in kg.
    db 4.2 ; Height in meters.

    db PALKIA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
