    ...
    db 894 ; Dex number.
    db <This Pok�mon is a cluster of electrical energy. It's said that removing the rings on Regieleki's body will unleash the Pok�mon's latent power.> ; Dex entry.

    db 145.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db REGIELEKI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
