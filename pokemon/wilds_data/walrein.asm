    ...
    db 365 ; Dex number.
    db <Walrein's two massively developed tusks can totally shatter blocks of ice weighing 10 tons with one blow. This Pok�mon's thick coat of blubber insulates it from subzero temperatures.> ; Dex entry.

    db 150.6 ; Weight in kg.
