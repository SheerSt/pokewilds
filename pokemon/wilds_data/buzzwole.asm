    ...
    db 794 ; Dex number.
    db <This Ultra Beast appeared from another world. It shows off its body, but whether that display is a boast or a threat remains unclear.> ; Dex entry.

    db 333.6 ; Weight in kg.
    db 2.4 ; Height in meters.

    db BUZZWOLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
