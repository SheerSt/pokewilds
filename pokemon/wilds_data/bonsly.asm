    ...
    db 438 ; Dex number.
    db <It expels both sweat and tears from its eyes. The sweat is a little salty, while the tears have a slight bitterness.> ; Dex entry.

    db 15.0 ; Weight in kg.
    db 0.5 ; Height in meters.

    db BONSLY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
