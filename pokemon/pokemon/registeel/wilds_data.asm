    ...
    db 379 ; Dex number.
    db <Registeel has a body that is harder than any kind of metal. Its body is apparently hollow. No one has any idea what this Pokémon eats.> ; Dex entry.

    db 205.0 ; Weight in kg.
    db 1.9 ; Height in meters.

    db REGISTEEL 100 ; Base form(s) (MON_NAME for base species, then chance).
