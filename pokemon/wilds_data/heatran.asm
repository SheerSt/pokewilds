    ...
    db 485 ; Dex number.
    db <It dwells in volcanic caves. It digs in with its cross-shaped feet to crawl on ceilings and walls.> ; Dex entry.

    db 430.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db HEATRAN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
