    db SHELLOS ; Display name (DEFAULT for default name).

    db 422 ; Dex number.
    db <There's speculation that its appearance is determined by what it eats, but the truth remains elusive.> ; Dex entry.

    db 6.3 ; Weight in kg.
    db 0.3 ; Height in meters.

    db SHELLOS_WEST 100 ; Base form(s) (MON_NAME for base species, then chance).
