    ...
    db 781 ; Dex number.
    db <After a piece of seaweed merged with debris from a sunken ship, it was reborn as this ghost Pok�mon.> ; Dex entry.

    db 210.0 ; Weight in kg.
    db 3.9 ; Height in meters.

    db DHELMISE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
