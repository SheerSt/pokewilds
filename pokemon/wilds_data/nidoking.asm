    ...
    db 34 ; Dex number.
    db <Nidoking's thick tail packs enormously destructive power. With one swing, it can topple a metal transmission tower. Once this Pok�mon goes on a rampage, there is no stopping it.> ; Dex entry.

    db 62.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db NIDORAN_M 50, NIDORAN_F 50 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
