    ...
    db 293 ; Dex number.
    db <The cry of a Whismur is over 100 decibels. If you're close to a Whismur when it lets out a cry, you'll be stuck with an all-day headache.> ; Dex entry.

    db 16.3 ; Weight in kg.
    db 0.6 ; Height in meters.

    db WHISMUR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
