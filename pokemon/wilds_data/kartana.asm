    ...
    db 798 ; Dex number.
    db <This Ultra Beast came from the Ultra Wormhole. It seems not to attack enemies on its own, but its sharp body is a dangerous weapon in itself.> ; Dex entry.

    db 0.1 ; Weight in kg.
    db 0.3 ; Height in meters.

    db KARTANA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
