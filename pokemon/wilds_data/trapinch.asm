    ...
    db 328 ; Dex number.
    db <Its nest is a sloped, bowl-like pit in the desert. Once something has fallen in, there is no escape.> ; Dex entry.

    db 15.0 ; Weight in kg.
    db 0.7 ; Height in meters.

    db TRAPINCH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db SAND_FISHING SAND_FISHING ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
