    ...
    db 454 ; Dex number.
    db <It bounces toward opponents and gouges them with poisonous claws. No more than a scratch is needed to knock out its adversaries.> ; Dex entry.

    db 44.4 ; Weight in kg.
    db 1.3 ; Height in meters.

    db CROAGUNK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
