    ...
    db 807 ; Dex number.
    db <It runs as fast as lightning strikes, shredding its opponents with its high-voltage claws.> ; Dex entry.

    db 44.5 ; Weight in kg.
    db 1.5 ; Height in meters.

    db ZERAORA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
