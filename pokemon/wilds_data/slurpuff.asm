    ...
    db 685 ; Dex number.
    db <By taking in a person's scent, it can sniff out their mental and physical condition. It's hoped that this skill will have many medical applications.> ; Dex entry.

    db 5.0 ; Weight in kg.
    db 0.8 ; Height in meters.

    db SWIRLIX 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
