    ...
    db 79 ; Dex number.
    db <Although this Pok�mon is normally zoned out, its expression abruptly sharpens on occasion. The cause for this seems to lie in Slowpoke's diet.> ; Dex entry.

    db 36.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db SLOWPOKE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db BEACH TIDAL_BEACH WOODED_LAKE ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
