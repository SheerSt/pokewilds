    ...
    db 615 ; Dex number.
    db <They are born in snow clouds. They use chains made of ice crystals to capture prey.> ; Dex entry.

    db 148.0 ; Weight in kg.
    db 1.1 ; Height in meters.

    db CRYOGONAL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
