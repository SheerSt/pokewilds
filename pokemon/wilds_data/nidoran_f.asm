    ...
    db 29 ; Dex number.
    db <Nidoran has barbs that secrete a powerful poison. They are thought to have developed as protection for this small-bodied Pok�mon. When enraged, it releases a horrible toxin from its horn.> ; Dex entry.

    db 7.0 ; Weight in kg.
    db 0.4 ; Height in meters.

    db NIDORAN_F 50, NIDIDORAN_M 50 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
