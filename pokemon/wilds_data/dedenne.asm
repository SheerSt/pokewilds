    ...
    db 702 ; Dex number.
    db <A Dedenne's whiskers pick up electrical waves other Dedenne send out. These Pok�mon share locations of food or electricity with one another.> ; Dex entry.

    db 2.2 ; Weight in kg.
    db 0.2 ; Height in meters.

    db DEDENNE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
