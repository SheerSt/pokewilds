    ...
    db 614 ; Dex number.
    db <It swims through frigid seas, searching for prey. From its frozen breath, it forms icy fangs that are harder than steel.> ; Dex entry.

    db 260.0 ; Weight in kg.
    db 2.6 ; Height in meters.

    db CUBCHOO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
