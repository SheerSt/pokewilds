    ...
    db 764 ; Dex number.
    db <Comfey picks flowers with its vine and decorates itself with them. For some reason, flowers won't wither once they're attached to a Comfey.> ; Dex entry.

    db 0.3 ; Weight in kg.
    db 0.1 ; Height in meters.

    db COMFEY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
