    ...
    db 474 ; Dex number.
    db <Porygon-Z had a program installed to allow it to move between dimensions, but the program also caused instability in Porygon-Z's behavior.> ; Dex entry.

    db 34.0 ; Weight in kg.
    db 0.9 ; Height in meters.

    db PORYGON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
