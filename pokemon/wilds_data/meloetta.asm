    ...
    db 648 ; Dex number.
    db <The melodies sung by Meloetta have the power to make Pokémon that hear them happy or sad.> ; Dex entry.

    db 6.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db MELOETTA, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
