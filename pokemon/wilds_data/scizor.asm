    ...
    db 212 ; Dex number.
    db <Bulky pincers account for one third of Scizor's body weight. A single swing of one of these pincers will crush a boulder completely.> ; Dex entry.

    db 118.0 ; Weight in kg.
