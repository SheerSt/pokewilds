    ...
    db 782 ; Dex number.
    db <They learn to fight by smashing their head scales together. The dueling strengthens both their skills and their spirits.> ; Dex entry.

    db 29.7 ; Weight in kg.
    db 0.6 ; Height in meters.

    db JANGMO-O 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
