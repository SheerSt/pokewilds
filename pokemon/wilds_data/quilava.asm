    ...
    db 156 ; Dex number.
    db <Quilava keeps its foes at bay with the intensity of its flames and gusts of superheated air. This Pok�mon applies its outstanding nimbleness to dodge attacks even while scorching the foe with flames.> ; Dex entry.

    db 19.0 ; Weight in kg.
    db 0.9 ; Height in meters.

    db CYNDAQUIL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
