    ...
    db 774 ; Dex number.
    db <Originally making its home in the ozone layer, it hurtles to the ground when the shell enclosing its body grows too heavy.> ; Dex entry.

    db 0.3 ; Weight in kg.
    db 0.3 ; Height in meters.

    db MINIOR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
