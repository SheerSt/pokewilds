    ...
    db 127 ; Dex number.
    db <These Pok�mon judge one another based on pincers. Thicker, more impressive pincers make for more popularity with the opposite gender.> ; Dex entry.

    db 55.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db PINSIR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
