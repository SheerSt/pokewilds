    ...
    db 809 ; Dex number.
    db <At the end of its life-span, Melmetal will rust and fall apart. The small shards left behind will eventually be reborn as Meltan.> ; Dex entry.

    db 800.0 ; Weight in kg.
    db 2.5 ; Height in meters.

    db MELTAN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
