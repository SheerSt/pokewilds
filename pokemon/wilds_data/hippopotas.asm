    ...
    db 449 ; Dex number.
    db <It moves through the sands with its mouth open, swallowing sand along with its prey. It gets rid of the sand by spouting it from its nose.> ; Dex entry.

    db 49.5 ; Weight in kg.
    db 0.8 ; Height in meters.

    db HIPPOPOTAS 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
