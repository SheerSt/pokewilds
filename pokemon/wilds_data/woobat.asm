    ...
    db 527 ; Dex number.
    db <While inside a cave, if you look up and see lots of heart-shaped marks lining the walls, it's evidence that Woobat live there.> ; Dex entry.

    db 2.1 ; Weight in kg.
    db 0.4 ; Height in meters.

    db WOOBAT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
