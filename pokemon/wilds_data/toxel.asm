    ...
    db 848 ; Dex number.
    db <It stores poison in an internal poison sac and secretes that poison through its skin. If you touch this Pok�mon, a tingling sensation follows.> ; Dex entry.

    db 11.0 ; Weight in kg.
    db 0.4 ; Height in meters.

    db TOXEL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
