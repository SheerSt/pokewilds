    ...
    db 207 ; Dex number.
    db <Gligar glides through the air without a sound as if it were sliding. This Pok�mon hangs on to the face of its foe using its clawed hind legs and the large pincers on its forelegs, then injects the prey with its poison barb.> ; Dex entry.

    db 64.8 ; Weight in kg.
    db 1.1 ; Height in meters.

    db GLIGAR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
