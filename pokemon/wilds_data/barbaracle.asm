    ...
    db 689 ; Dex number.
    db <Seven Binacle come together to form one Barbaracle. The Binacle that serves as the head gives orders to those serving as the limbs.> ; Dex entry.

    db 96.0 ; Weight in kg.
