    ...
    db 337 ; Dex number.
    db <The phase of the moon apparently has some effect on its power. It's active on the night of a full moon.> ; Dex entry.

    db 168.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db LUNATONE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db RUINS_INNER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
