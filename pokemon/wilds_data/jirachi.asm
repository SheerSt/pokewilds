    ...
    db 385 ; Dex number.
    db <Once every 1,000 years, the singing of a pure voice will rouse this Pok�mon from its near- perpetual slumber. It wakes for only seven days.> ; Dex entry.

    db 1.1 ; Weight in kg.
    db 0.3 ; Height in meters.

    db JIRACHI 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
