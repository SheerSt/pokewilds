    ...
    db 441 ; Dex number.
    db <It mimics the cries of other Pokémon to trick them into thinking it's one of them. This way they won't attack it.> ; Dex entry.

    db 1.9 ; Weight in kg.
    db 0.5 ; Height in meters.

    db CHATOT, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
