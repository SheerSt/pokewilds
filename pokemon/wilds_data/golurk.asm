    ...
    db 623 ; Dex number.
    db <Artillery platforms built into the walls of ancient castles served as perches from which Golurk could fire energy beams.> ; Dex entry.

    db 330.0 ; Weight in kg.
    db 2.8 ; Height in meters.

    db GOLETT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
