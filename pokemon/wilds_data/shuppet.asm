    ...
    db 353 ; Dex number.
    db <Shuppet is attracted by feelings of jealousy and vindictiveness. If someone develops strong feelings of vengeance, this Pok�mon will appear in a swarm and line up beneath the eaves of that person's home.> ; Dex entry.

    db 2.3 ; Weight in kg.
    db 0.6 ; Height in meters.

    db SHUPPET 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
