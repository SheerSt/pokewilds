    ...
    db 490 ; Dex number.
    db <It is born with a wondrous power that lets it bond with any kind of Pokémon.> ; Dex entry.

    db 1.4 ; Weight in kg.
    db 0.3 ; Height in meters.

    db MANAPHY 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
