    ...
    db 834 ; Dex number.
    db <It responded to Gigantamax energy by becoming bipedal. First it comes crashing down on foes, and then it finishes them off with its massive jaws.> ; Dex entry.

    db 115.5 ; Weight in kg.
    db 1.0 ; Height in meters.

    db CHEWTLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
