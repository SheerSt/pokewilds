    ...
    db 750 ; Dex number.
    db <Mud that hardens around a Mudsdale's legs sets harder than stone. It's so hard that it allows this Pok�mon to scrap a truck with a single kick.> ; Dex entry.

    db 920.0 ; Weight in kg.
    db 2.5 ; Height in meters.

    db MUDBRAY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
