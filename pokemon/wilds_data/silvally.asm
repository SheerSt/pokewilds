    ...
    db 773 ; Dex number.
    db <A solid bond of trust between this Pok�mon and its Trainer awakened the strength hidden within Silvally. It can change its type at will.> ; Dex entry.

    db 100.5 ; Weight in kg.
    db 2.3 ; Height in meters.

    db TYPE_NULL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
