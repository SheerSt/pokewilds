    ...
    db 532 ; Dex number.
    db <It loves helping out with construction projects. It loves it so much that if rain causes work to halt, it swings its log around and throws a tantrum.> ; Dex entry.

    db 12.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db TIMBURR 100 ; Base form(s) (MON_NAME for base species, then chance).
    ...
    db LOG, TYPE ; Harvestable items (TYPE as the final argument to apply type-based default items).
