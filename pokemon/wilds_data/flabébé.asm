    ...
    db 669 ; Dex number.
    db <It draws out and controls the hidden power of flowers. The flower Flab�b� holds is most likely part of its body.> ; Dex entry.

    db 0.1 ; Weight in kg.
    db 0.1 ; Height in meters.

    db FLAB�B� 100 ; Base form(MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma)nce).
