    ...
    db 229 ; Dex number.
    db <In a Houndoom pack, the one with its horns raked sharply toward the back serves a leadership role. These Pok�mon choose their leader by fighting among themselves.> ; Dex entry.
