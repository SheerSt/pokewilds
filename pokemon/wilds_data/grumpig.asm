    ...
    db 326 ; Dex number.
    db <Grumpig uses the black pearls on its body to amplify its psychic power waves for gaining total control over its foe. When this Pok�mon uses its special power, its snorting breath grows labored.> ; Dex entry.

    db 71.5 ; Weight in kg.
    db 0.9 ; Height in meters.

    db SPOINK 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
