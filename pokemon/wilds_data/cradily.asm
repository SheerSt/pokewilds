    ...
    db 346 ; Dex number.
    db <Cradily roams around the ocean floor in search of food. This Pok�mon freely extends its tree trunk-like neck and captures unwary prey using its eight tentacles.> ; Dex entry.

    db 60.4 ; Weight in kg.
