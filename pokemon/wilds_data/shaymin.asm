    ...
    db 492 ; Dex number.
    db <It can dissolve toxins in the air to instantly transform ruined land into a lush field of flowers.> ; Dex entry.

    db 2.1 ; Weight in kg.
    db 0.2 ; Height in meters.

    db SHAYMIN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
