    ...
    db 626 ; Dex number.
    db <These Pok�mon can crush a car with no more than a headbutt. Bouffalant with more hair on their heads hold higher positions within the herd.> ; Dex entry.

    db 94.6 ; Weight in kg.
    db 1.6 ; Height in meters.

    db BOUFFALANT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
