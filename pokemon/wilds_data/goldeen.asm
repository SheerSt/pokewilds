    ...
    db 118 ; Dex number.
    db <Its dorsal, pectoral, and tail fins wave elegantly in water. That is why it is known as the Water Dancer.> ; Dex entry.

    db 15.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db GOLDEEN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db MOUNTAIN_WATER WOODED_LAKE_WATER WOODED_LAKE_FISHING OASIS_POND RIVER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
