    ...
    db 478 ; Dex number.
    db <After a woman met her end on a snowy mountain, her regrets lingered on. From them, this Pok�mon was born. Its favorite food is frozen souls.> ; Dex entry.

    db 26.6 ; Weight in kg.
    db 1.3 ; Height in meters.

    db SNORUNT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
