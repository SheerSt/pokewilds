    ...
    db 889 ; Dex number.
    db <In times past, it worked together with a king of the people to save the Galar region. It absorbs metal that it then uses in battle.> ; Dex entry.

    db 785.0 ; Weight in kg.
    db 2.9 ; Height in meters.

    db ZAMAZENTA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
