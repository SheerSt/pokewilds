    ...
    db 4 ; Dex number.
    db <It has a preference for hot things. When it rains, steam is said to spout from the tip of its tail.> ; Dex entry.

    db 8.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db CHARMANDER 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db FOREST SAVANNA VOLCANO ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
