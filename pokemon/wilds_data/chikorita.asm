    ...
    db 152 ; Dex number.
    db <In battle, Chikorita waves its leaf around to keep the foe at bay. However, a sweet fragrance also wafts from the leaf, becalming the battling Pok�mon and creating a cozy, friendly atmosphere all around.> ; Dex entry.

    db 6.4 ; Weight in kg.
    db 0.9 ; Height in meters.

    db CHIKORITA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
