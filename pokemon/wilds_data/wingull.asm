    ...
    db 278 ; Dex number.
    db <It makes its nest on sheer cliffs. Riding the sea breeze, it glides up into the expansive skies.> ; Dex entry.

    db 9.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db WINGULL 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db BEACH TIDAL_BEACH_PLATEAU ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
