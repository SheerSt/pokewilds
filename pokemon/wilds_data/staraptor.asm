    ...
    db 398 ; Dex number.
    db <The muscles in its wings and legs are strong. It can easily fly while gripping a small Pok�mon.> ; Dex entry.

    db 24.9 ; Weight in kg.
    db 1.2 ; Height in meters.

    db STARLY 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
