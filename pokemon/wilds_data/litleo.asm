    ...
    db 667 ; Dex number.
    db <The stronger the opponent it faces, the more heat surges from its mane and the more power flows through its body.> ; Dex entry.

    db 13.5 ; Weight in kg.
    db 0.6 ; Height in meters.

    db LITLEO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
