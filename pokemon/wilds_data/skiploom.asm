    ...
    db 188 ; Dex number.
    db <Skiploom's flower blossoms when the temperature rises above 64 degrees Fahrenheit. How much the flower opens depends on the temperature. For that reason, this Pokémon is sometimes used as a thermometer.> ; Dex entry.

    db 1.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db HOPPIP 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
