    ...
    db 250 ; Dex number.
    db <Ho-Oh's feathers glow in seven colors depending on the angle at which they are struck by light. These feathers are said to bring happiness to the bearers. This Pok�mon is said to live at the foot of a rainbow.> ; Dex entry.

    db 199.0 ; Weight in kg.
    db 3.8 ; Height in meters.

    db HO-OH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
