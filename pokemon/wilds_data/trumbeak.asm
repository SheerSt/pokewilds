    ...
    db 732 ; Dex number.
    db <It eats berries and stores their seeds in its beak. When it encounters enemies or prey, it fires off all the seeds in a burst.> ; Dex entry.

    db 14.8 ; Weight in kg.
