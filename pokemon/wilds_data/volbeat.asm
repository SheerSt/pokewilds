    ...
    db 313 ; Dex number.
    db <With the arrival of night, Volbeat emits light from its tail. It communicates with others by adjusting the intensity and flashing of its light. This Pok�mon is attracted by the sweet aroma of Illumise.> ; Dex entry.

    db 17.7 ; Weight in kg.
    db 0.7 ; Height in meters.

    db VOLBEAT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
