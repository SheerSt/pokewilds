    ...
    db 695 ; Dex number.
    db <A now-vanished desert culture treasured these Pok�mon. Appropriately, when Heliolisk came to the Galar region, treasure came with them.> ; Dex entry.

    db 21.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db HELIOPTILE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
