    ...
    db 892 ; Dex number.
    db <As it waits for the right moment to unleash its Gigantamax power, this Pokémon maintains a perfect one-legged stance. It won't even twitch.> ; Dex entry.

    db 105.0 ; Weight in kg.
    db 1.9 ; Height in meters.

    db KUBFU 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
