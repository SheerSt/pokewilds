    ...
    db 291 ; Dex number.
    db <Its cry leaves a lasting headache if heard for too long. It moves so quickly that it is almost invisible.> ; Dex entry.

    db 12.0 ; Weight in kg.
    db 0.8 ; Height in meters.

    db NINCADA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
