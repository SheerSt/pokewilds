    ...
    db 854 ; Dex number.
    db <The swirl pattern in this Pokémon's body is its weakness. If it gets stirred, the swirl loses its shape, and Sinistea gets dizzy.> ; Dex entry.

    db 0.2 ; Weight in kg.
    db 0.1 ; Height in meters.

    db SINISTEA 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
