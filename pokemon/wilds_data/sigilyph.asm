    ...
    db 561 ; Dex number.
    db <Psychic power allows these Pok�mon to fly. Some say they were the guardians of an ancient city. Others say they were the guardians' emissaries.> ; Dex entry.

    db 14.0 ; Weight in kg.
    db 1.4 ; Height in meters.

    db SIGILYPH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db RUINS_OUTER ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
