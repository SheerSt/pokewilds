    ...
    db 15 ; Dex number.
    db <Beedrill is extremely territorial. No one should ever approach its nest�this is for their own safety. If angered, they will attack in a furious swarm.> ; Dex entry.
