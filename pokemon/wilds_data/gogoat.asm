    ...
    db 673 ; Dex number.
    db <It can tell how its Trainer is feeling by subtle shifts in the grip on its horns. This empathic sense lets them run as if one being.> ; Dex entry.

    db 91.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db SKIDDO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
