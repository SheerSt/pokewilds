    ...
    db 347 ; Dex number.
    db <Anorith was regenerated from a prehistoric fossil. This primitive Pok�mon once lived in warm seas. It grips its prey firmly between its two large claws.> ; Dex entry.
    ...
    db 2 ; Water offset for OW sprites, in pixels.