    ...
    db 276 ; Dex number.
    db <Taillow courageously stands its ground against foes, however strong they may be. This gutsy Pok�mon will remain defiant even after a loss. On the other hand, it cries loudly if it becomes hungry.> ; Dex entry.

    db 2.3 ; Weight in kg.
    db 0.3 ; Height in meters.

    db TAILLOW 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).

    db FOREST SAVANNA WOODED_LAKE ; Spawning biomes (TYPE as the final argument to apply type-based default tiles).
