    ...
    db 302 ; Dex number.
    db <This Pokémon is feared. When its gemstone eyes begin to glow with a sinister shine, it's believed that Sableye will steal people's spirits away.> ; Dex entry.

    db 11.0 ; Weight in kg.
    db 0.5 ; Height in meters.

    db SABLEYE 100 ; Base form(s) (MON_NAME for base species, then chance).
    ...
    db WATER_STONE FIRE_STONE LEAF_STONE THUNDERSTONE MOON_STONE SUN_STONE ICE_STONE DAWN_STONE DUSK_STONE SHINY_STONE TYPE TYPE TYPE TYPE TYPE TYPE TYPE TYPE TYPE ; Harvestable items (TYPE as the final argument to apply type-based default items).
