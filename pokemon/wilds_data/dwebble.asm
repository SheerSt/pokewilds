    ...
    db 557 ; Dex number.
    db <When it finds a stone appealing, it creates a hole inside it and uses it as its home. This Pok�mon is the natural enemy of Roggenrola and Rolycoly.> ; Dex entry.

    db 14.5 ; Weight in kg.
    db 0.3 ; Height in meters.

    db DWEBBLE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
