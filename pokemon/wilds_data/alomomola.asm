    ...
    db 594 ; Dex number.
    db <It uses its special mucus to close the wounds of injured Pok�mon. The reason for this behavior remains unknown.> ; Dex entry.

    db 31.6 ; Weight in kg.
    db 1.2 ; Height in meters.

    db ALOMOMOLA 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
