    ...
    db 40 ; Dex number.
    db <The more air it takes in, the more it inflates. If opponents catch it in a bad mood, it will inflate itself to an enormous size to intimidate them.> ; Dex entry.

    db 12.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db IGGLYBUFF 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
