    db DARUMAKA ; Display name (DEFAULT for default name).

    db 554 ; Dex number.
    db <It derives its power from fire burning inside its body. If the fire dwindles, this Pok�mon will immediately fall asleep.> ; Dex entry.
