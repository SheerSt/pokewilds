    ...
    db 101 ; Dex number.
    db <Electrode eats electricity in the atmosphere. On days when lightning strikes, you can see this Pok�mon exploding all over the place from eating too much electricity.> ; Dex entry.
