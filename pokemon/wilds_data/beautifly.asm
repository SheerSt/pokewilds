    ...
    db 267 ; Dex number.
    db <Beautifly's favorite food is the sweet pollen of flowers. If you want to see this Pok�mon, just leave a potted flower by an open window. Beautifly is sure to come looking for pollen.> ; Dex entry.

    db 28.4 ; Weight in kg.
