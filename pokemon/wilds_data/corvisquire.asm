    ...
    db 822 ; Dex number.
    db <Smart enough to use tools in battle, these Pok�mon have been seen picking up rocks and flinging them or using ropes to wrap up enemies.> ; Dex entry.

    db 16.0 ; Weight in kg.
    db 0.8 ; Height in meters.

    db ROOKIDEE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
