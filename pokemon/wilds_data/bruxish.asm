    ...
    db 779 ; Dex number.
    db <When it unleashes its psychic power from the protuberance on its head, the grating sound of grinding teeth echoes through the area.> ; Dex entry.

    db 19.0 ; Weight in kg.
    db 0.9 ; Height in meters.

    db BRUXISH 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
