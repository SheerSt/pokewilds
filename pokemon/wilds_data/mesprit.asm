    ...
    db 481 ; Dex number.
    db <Known as �The Being of Emotion.� It taught humans the nobility of sorrow, pain, and joy.> ; Dex entry.

    db 0.3 ; Weight in kg.
    db 0.3 ; Height in meters.

    db MESPRIT 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
