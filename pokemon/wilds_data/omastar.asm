    ...
    db 139 ; Dex number.
    db <Omastar uses its tentacles to capture its prey. It is believed to have become extinct because its shell grew too large and heavy, causing its movements to become too slow and ponderous.> ; Dex entry.

    db 35.0 ; Weight in kg.
    db 1.0 ; Height in meters.

    db OMANYTE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
