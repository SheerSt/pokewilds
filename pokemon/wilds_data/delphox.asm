    ...
    db 655 ; Dex number.
    db <It gazes into the flame at the tip of its branch to achieve a focused state, which allows it to see into the future.> ; Dex entry.

    db 39.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db FENNEKIN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
