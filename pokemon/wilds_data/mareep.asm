    ...
    db 179 ; Dex number.
    db <Mareep's fluffy coat of wool rubs together and builds a static charge. The more static electricity is charged, the more brightly the lightbulb at the tip of its tail glows.> ; Dex entry.

    db 7.8 ; Weight in kg.
    db 0.6 ; Height in meters.

    db MAREEP 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
