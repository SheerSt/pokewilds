    ...
    db 102 ; Dex number.
    db <Though it may look like it's just a bunch of eggs, it's a proper Pok�mon. Exeggcute communicates with others of its kind via telepathy, apparently.> ; Dex entry.

    db 2.5 ; Weight in kg.
    db 0.4 ; Height in meters.

    db EXEGGCUTE 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
