    ...
    db 243 ; Dex number.
    db <Raikou embodies the speed of lightning. The roars of this Pok�mon send shock waves shuddering through the air and shake the ground as if lightning bolts had come crashing down.> ; Dex entry.

    db 178.0 ; Weight in kg.
    db 1.9 ; Height in meters.

    db RAIKOU 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
