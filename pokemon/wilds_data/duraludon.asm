    ...
    db 884 ; Dex number.
    db <Its body resembles polished metal, and it's both lightweight and strong. The only drawback is that it rusts easily.> ; Dex entry.

    db 40.0 ; Weight in kg.
    db 1.8 ; Height in meters.

    db DURALUDON 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
