    ...
    db 534 ; Dex number.
    db <Concrete mixed by Conkeldurr is much more durable than normal concrete, even when the compositions of the two materials are the same.> ; Dex entry.

    db 87.0 ; Weight in kg.
    ...
    db CONCRETE, TYPE ; Harvestable items (TYPE as the final argument to apply type-based default items).
