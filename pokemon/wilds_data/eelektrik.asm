    ...
    db 603 ; Dex number.
    db <It wraps itself around its prey and paralyzes it with electricity from the round spots on its sides. Then it chomps.> ; Dex entry.

    db 22.0 ; Weight in kg.
    db 1.2 ; Height in meters.

    db TYNAMO 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
