    ...
    db 468 ; Dex number.
    db <These Pokémon are never seen anywhere near conflict or turmoil. In recent times, they've hardly been seen at all.> ; Dex entry.

    db 38.0 ; Weight in kg.
    db 1.5 ; Height in meters.

    db TOGEPI, 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
