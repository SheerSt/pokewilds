    ...
    db 888 ; Dex number.
    db <Known as a legendary hero, this Pok�mon absorbs metal particles, transforming them into a weapon it uses to battle.> ; Dex entry.

    db 355.0 ; Weight in kg.
    db 2.8 ; Height in meters.

    db ZACIAN 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
