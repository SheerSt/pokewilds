    ...
    db 246 ; Dex number.
    db <Born deep underground, it comes aboveground and becomes a pupa once it has finished eating the surrounding soil.> ; Dex entry.

    db 72.0 ; Weight in kg.
    db 0.6 ; Height in meters.

    db LARVITAR 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
