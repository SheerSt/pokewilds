    db URSHIFU ; Display name (DEFAULT for default name).

    db 892 ; Dex number.
    db <This form of Urshifu is a strong believer in the one-hit KO. Its strategy is to leap in close to foes and land a devastating blow with a hardened fist.> ; Dex entry.

    db 105.0 ; Weight in kg.
    db 1.9 ; Height in meters.

    db KUBFU 100 ; Base form(s) (MON_NAME for base species, then chance).
