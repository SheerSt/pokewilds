    ...
    db 286 ; Dex number.
    db <Breloom closes in on its foe with light and sprightly footwork, then throws punches with its stretchy arms. This Pok�mon's fighting technique puts boxers to shame.> ; Dex entry.
