    ...
    db 225 ; Dex number.
    db <It carries food all day long. There are tales about lost people who were saved by the food it had.> ; Dex entry.

    db 16.0 ; Weight in kg.
    db 0.9 ; Height in meters.

    db DELIBIRD 100 ; Base form(s) (MON_NAME for Pokemon's name, then chance to hatch; separate groups with a comma).
