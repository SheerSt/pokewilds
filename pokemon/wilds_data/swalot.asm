    ...
    db 317 ; Dex number.
    db <When Swalot spots prey, it spurts out a hideously toxic fluid from its pores and sprays the target. Once the prey has weakened, this Pokémon gulps it down whole with its cavernous mouth.> ; Dex entry.

    db 80.0 ; Weight in kg.
    db 1.7 ; Height in meters.

    db GULPIN 100 ; Base form(s) (DEFAULT for default mon, MON_NAME for a specific mon, then chance).
